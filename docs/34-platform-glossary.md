...
1. **The site is the base, not the shop.** The website exists with zero commerce. Selling is
   the **Commerce** module, layered on. A tenant on Storefront + CMS has a complete site with
   no store.
2. **Brand sits above the site.** Brand is a tenant primitive. The site (and dashboard, email,
   ...
   single-site tenants are unaffected. You do **not** need a site/storefront to have a brand; the
