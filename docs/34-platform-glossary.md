...
| **Theme**                    | A **presentation** preset (apex, industrial, drift, market, fleet, drop) + the tenant's overlay. How the site looks.                                   | Brand/identity.                                                                                   | `packages/storefront-themes`; `StorefrontTheme`                                     |
