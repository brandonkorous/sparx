# `wizeworks/apps/admin` — feature docs

Per-feature specs for the **WizeWorks admin portal** (`admin.wize.works`, `wizeworks/apps/admin`). These are the
...
- **Build plan (how):** [build-plan.md](build-plan.md) — the phased, grounded plan for building `wizeworks/apps/admin`:
...
allowlisted. `wizeworks/apps/admin` is currently an empty placeholder; these docs capture the feature requirements
