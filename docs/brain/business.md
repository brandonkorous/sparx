...
- [[terminology]] — retired vs kept terms (storefront→**site**, store→site, merchant→tenant).

## Who

**WizeWorks** builds **sparx** (`sparx.works`). Read `docs/01-platform-vision.md` first for the full vision.

## Sources of truth

`docs/01-platform-vision.md` · `docs/17-billing-subscriptions.md` · root `CLAUDE.md` "What this product is".
