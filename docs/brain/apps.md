...
| **workbench** `@sparx/workbench` | multi-window operator workbench (dockable panes, tab tear-off; docs/123) — browser-rendered over api-rest via token BFF | Next.js 16, silicaui, dockview | 3011 |
| **site** `@wizeworks/site` | tenant site renderer (the live Builder output) | Next.js, site-ui / site-themes, builder-render | 3000 |
| **market** `@sparx/market` | sparx.market first-party marketplace (MoR checkout channel) | Next.js, Stripe.js | 3000 |
| **web** `@sparx/web` | WizeWorks marketing site + auth pages | Next.js, posthog | 3000 |
