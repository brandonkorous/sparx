...
| **site** `@sparx/site` | tenant storefront renderer (the live Builder output) | Next.js, site-ui / site-themes, builder-render | 3000 |
| **market** `@sparx/market` | sparx.market first-party marketplace storefront (MoR channel) | Next.js, Stripe.js | 3000 |
