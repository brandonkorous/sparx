...
| retired | use | detail |
|---|---|---|
| **storefront** | **site** | The tenant-facing web system is a *site* — `apps/site`, `@sparx/site-ui`, `@sparx/site-themes`, CSS prefix `--st-*` / `.st-c-*` (**st = site**, renamed from `sf-`). |
...
- Prefixes: `--st-*` = **site**; `sx-` = `@sparx/ui` (dashboard). Never confuse the two.
