...
- **Postgres FTS, not Typesense/Elasticsearch** — **partially superseded:** Typesense is **already live** (`k8s/typesense/`, `@sparx/search`, commerce-indexer) — a deliberate, documented deviation for Gillett Diesel fitment-faceted search (docs/22). Elasticsearch remains Phase 3.
