...
[app/page.tsx](../../apps/site/app/page.tsx), gives exact parity with no per-tenant data
...
`sectionsForScope(snapshot,'home')` in [app/page.tsx](../../apps/site/app/page.tsx); the helper is
