...
| `registry.tsx` canvas render fns                                     | **deleted** (render lives in `@sparx/builder-render`) |
...
render through `@sparx/builder-render` ([02](02-canvas-live-renderer-unification.md)),
...
- Lint + typecheck clean across `@sparx/dashboard`, `@sparx/api-rest`,
  `@sparx/sitebuilder`, and the new `@sparx/builder-render`.
