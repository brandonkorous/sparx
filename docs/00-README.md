...
| 56  | Live Chat Module                    | Built-in customer communication: storefront widget, AI-first responses (Claude Haiku + Typesense product context), merchant dashboard inbox, sparx.market integration. +$19/mo module.                                                                                                                         |
