...
**Version:** 1.10 (Phases 1–6 + 7a + 8a/8b built; 7b email render path + per-site blueprint install + new-site wizard built 2026-06-12; `EmailEvent.property_id` now persisted per send + new-site discard-confirm; order-trigger payoff tracked as Phase 9; only 7b authoring/overrides remain — BLOCKED on email-defaults)
...
[09-ecommerce-prd.md](09-ecommerce-prd.md) checkout/order events.
