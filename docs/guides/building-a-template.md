...
is the worked example, generated by `_gen/gen-farm-fresh-bowls.ts`.
...
> serializes the compiled manifest to `blueprint.ts` as `export default { … }`. See
> [`_gen/gen-farm-fresh-bowls.ts`](../../marketplace-catalog/_gen/gen-farm-fresh-bowls.ts)
