// sparx — Boutique: a THEMED CLONE of the golden `sparx`
// blueprint, re-dressed in the 'boutique' silica theme. Same
...
const blueprint = {
  ...
  name: 'sparx — Boutique',
  summary:
    'The complete sparx starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Boutique look, tuned for small fashion retail. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'retail',
  ...
  // The provisioned SiteTheme the installer creates + applies — the 'boutique'
  // look as a tenant-editable saved theme (base preset boutique + this theme's brand look).
  theme: {
    name: 'boutique',
    basePresetKey: 'boutique',
    presentation: {
      v: 2,
