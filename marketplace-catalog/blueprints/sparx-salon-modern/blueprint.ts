// sparx — Salon (Modern): a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-salon-modern.ts via the shared
...
const blueprint = {
  ...
  brand: {
    businessName: 'Wildroot',
    tagline: 'Real hair, real people, no rushing.',
    colors: {
      primary: '#b55934',
