// sparx — Auto Repair (Neighborhood): a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-auto-neighborhood.ts via the shared
...
const blueprint = {
    ...
    brand: {
        businessName: 'Sparrow & Sons Auto',
        tagline: 'We’ll tell you what it actually needs.',
        colors: {
            primary: '#1d4d87',
