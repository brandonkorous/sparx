// sparx — Kitchenware & Cookware: a reference-driven SITE TEMPLATE (docs/templates/*),
...
//
// GENERATED by marketplace-catalog/_gen/gen-template-retail-kitchenware.ts
...
const blueprint = {
  ...
  theme: {
    name: 'retail-kitchenware',
    basePresetKey: 'retail-kitchenware',
    presentation: {
      v: 2,
