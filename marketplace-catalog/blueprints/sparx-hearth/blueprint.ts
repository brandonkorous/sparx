// sparx — Hearth: a THEMED CLONE of the golden `sparx`
...
const blueprint = {
  ...
  name: 'sparx — Hearth',
  summary:
    'The complete sparx starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Hearth look, tuned for home services, interiors, and furnishings. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'services',
  ...
  // look as a tenant-editable saved theme (base preset hearth + this theme's brand look).
  theme: {
    name: 'hearth',
