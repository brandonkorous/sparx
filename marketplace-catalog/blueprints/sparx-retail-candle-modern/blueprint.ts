...
//
// GENERATED by marketplace-catalog/_gen/gen-template-retail-candle-modern.ts
...
const blueprint = {
  ...
  theme: {
    name: 'retail-candle-modern',
    basePresetKey: 'retail-candle-modern',
    presentation: {
      v: 2,
