// sparx — Dog Training (Classes): a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-dogtraining-classes.ts via the shared
...
const blueprint = {
  ...
  brand: {
    businessName: 'Good Dog Academy',
    tagline: 'Every good dog starts here.',
    colors: {
      primary: '#25a284',
      primaryForeground: '#030e0a',
      accent: '#ed845b',
      secondary: '#214444',
    },
    fonts: {
