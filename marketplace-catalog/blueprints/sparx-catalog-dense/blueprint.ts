// sparx — Catalog Dense: a reference-driven SITE TEMPLATE (docs/templates/*),
...
//
// GENERATED by marketplace-catalog/_gen/gen-template-catalog-dense.ts
