// sparx — Garage: a THEMED CLONE of the golden `sparx`
// blueprint, re-dressed in the 'garage' silica theme. Same
...
const blueprint = {
  ...
  name: 'sparx — Garage',
  summary:
    'The complete sparx starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Garage look, tuned for vehicle service, repair, and parts. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'services',
  ...
  // The provisioned SiteTheme the installer creates + applies — the 'garage'
