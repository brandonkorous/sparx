// sparx — HVAC (Comfort): a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-hvac-comfort.ts via the shared
...
const blueprint = {
  ...
  brand: {
    businessName: 'Evenair Heating & Cooling',
    tagline: 'Never too hot, never too cold.',
    colors: {
      primary: '#e28339',
      primaryForeground: '#120904',
      accent: '#45a4d0',
      secondary: '#344455',
    },
    fonts: {
