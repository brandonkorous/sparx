// sparx — Workshop: a THEMED CLONE of the golden `sparx`
...
const blueprint = {
  ...
  name: 'sparx — Workshop',
  summary:
    'The complete sparx starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Workshop look, tuned for fabrication, joinery, and general trade. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'services',
  ...
  // look as a tenant-editable saved theme (base preset workshop + this theme's brand look).
  theme: {
    name: 'workshop',
