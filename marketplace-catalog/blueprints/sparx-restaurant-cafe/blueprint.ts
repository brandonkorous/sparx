// sparx — Café: a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-restaurant-cafe.ts via the shared
