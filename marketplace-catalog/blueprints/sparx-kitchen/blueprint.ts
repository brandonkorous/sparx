// sparx — Kitchen: a THEMED CLONE of the golden `sparx`
...
const blueprint = {
  ...
  name: 'sparx — Kitchen',
  summary:
    'The complete sparx starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Kitchen look, tuned for restaurants, cafés, and bakeries. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'retail',
  ...
  // look as a tenant-editable saved theme (base preset kitchen + this theme's brand look).
  theme: {
    name: 'kitchen',
