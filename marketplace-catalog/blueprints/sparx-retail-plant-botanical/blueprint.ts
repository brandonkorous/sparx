...
//
// GENERATED by marketplace-catalog/_gen/gen-template-retail-plant-botanical.ts
...
const blueprint = {
  ...
  theme: {
    name: 'retail-plant-botanical',
    basePresetKey: 'retail-plant-botanical',
    presentation: {
      v: 2,
