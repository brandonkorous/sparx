// sparx — Ledger: a THEMED CLONE of the golden `sparx`
// blueprint, re-dressed in the 'ledger' silica theme. Same
...
const blueprint = {
  ...
  name: 'sparx — Ledger',
  summary:
    'The complete sparx starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Ledger look, tuned for accountancy, law, and financial advice. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'services',
  ...
  // The provisioned SiteTheme the installer creates + applies — the 'ledger'
  // look as a tenant-editable saved theme (base preset ledger + this theme's brand look).
  theme: {
    name: 'ledger',
    basePresetKey: 'ledger',
    presentation: {
      v: 2,
