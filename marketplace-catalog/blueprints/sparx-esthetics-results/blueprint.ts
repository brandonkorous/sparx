// sparx — Esthetics (Results): a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-esthetics-results.ts via the shared
...
const blueprint = {
    ...
    brand: {
        ...
        tagline: 'Real results, glowing skin.',
        colors: {
            primary: '#a85e89',
