// sparx — Wedding Planner (Luxe): a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-weddingplanner-luxe.ts via the shared
...
const blueprint = {
    ...
    brand: {
        ...
        tagline: 'Weddings, beautifully handled.',
        colors: {
            primary: '#c28f92',
