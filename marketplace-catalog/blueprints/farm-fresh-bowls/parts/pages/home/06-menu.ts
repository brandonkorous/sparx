// Farm Fresh Bowls — Home page · Menu (GENERATED payload part, docs/85). Pure data, no imports.
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  type: 'Stack',
                  props: {},
                  class: 'mx-auto w-full max-w-site flex flex-col gap-2 items-start p-6 @3xl:p-10',
                  children: [
                    {
                      id: 'ffb-81',
                      type: 'Stack',
