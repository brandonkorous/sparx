...
//
// GENERATED by marketplace-catalog/_gen/gen-template-retail-outdoor-minimal.ts
...
const blueprint = {
  ...
  theme: {
    name: 'retail-outdoor-minimal',
    basePresetKey: 'retail-outdoor-minimal',
    presentation: {
      v: 2,
