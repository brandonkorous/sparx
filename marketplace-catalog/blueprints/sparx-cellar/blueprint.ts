...
const blueprint = {
  ...
  name: 'Cellar',
  summary:
    'The complete starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Cellar look, tuned for wine, beer, spirits, and bars. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'retail',
