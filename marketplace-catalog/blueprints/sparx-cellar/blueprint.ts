// sparx — Cellar: a THEMED CLONE of the golden `sparx`
// blueprint, re-dressed in the 'cellar' silica theme. Same
...
const blueprint = {
  ...
  name: 'sparx — Cellar',
  summary:
    'The complete sparx starter — a faceted shop, a journal, a booking page, and a wholesale page — in the Cellar look, tuned for wine, beer, spirits, and bars. Install it, make it yours, and launch a polished working site in minutes.',
  vertical: 'retail',
  ...
  // The provisioned SiteTheme the installer creates + applies — the 'cellar'
  // look as a tenant-editable saved theme (base preset cellar + this theme's brand look).
  theme: {
    name: 'cellar',
    basePresetKey: 'cellar',
    presentation: {
      v: 2,
