...
//
// GENERATED by marketplace-catalog/_gen/gen-template-retail-apparel-minimal.ts
...
const blueprint = {
  ...
  theme: {
    name: 'retail-apparel-minimal',
    basePresetKey: 'retail-apparel-minimal',
    presentation: {
      v: 2,
