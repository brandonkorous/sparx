// sparx — Stage: a THEMED CLONE of the golden `sparx`
// blueprint, re-dressed in the 'stage' silica theme. Same
...
const blueprint = {
  ...
  // The provisioned SiteTheme the installer creates + applies — the 'stage'
