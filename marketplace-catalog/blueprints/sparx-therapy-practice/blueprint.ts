// sparx — Therapy Practice: a BOOKING-BACKED service-business SITE TEMPLATE.
//
// GENERATED by marketplace-catalog/_gen/gen-sparx-therapy-practice.ts via the shared
...
const blueprint = {
  ...
  brand: {
    businessName: 'Anchor Counseling',
    tagline: 'Steady support, whenever you’re ready.',
    colors: {
      primary: '#60846c',
