// sparx — Harbor: a THEMED CLONE of the golden `sparx`
// blueprint, re-dressed in the 'harbor' silica theme. Same
...
const blueprint = {
  ...
  // The provisioned SiteTheme the installer creates + applies — the 'harbor'
  // look as a tenant-editable saved theme (base preset harbor + this theme's brand look).
  theme: {
    name: 'harbor',
    basePresetKey: 'harbor',
    presentation: {
      v: 2,
