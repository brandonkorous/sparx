...
const centeredHero = (): BuilderNode =>
  node('Section', {
    ...
    children: [
      node('Heading', {
        box: { align: 'center' },
        props: { level: 'h1', text: { $prop: 'heading' } },
      }),
      node('Text', {
        box: { align: 'center' },
...
const pricingTable = (): BuilderNode =>
  node('Section', {
    ...
    children: [
      node('Heading', {
        box: { align: 'center' },
        props: { level: 'h2', text: 'Simple, fair pricing' },
      }),
      node('Grid', {
...
const testimonialBand = (): BuilderNode =>
  node('Section', {
    ...
    children: [
      node('Heading', {
        box: { align: 'center' },
        props: { level: 'h2', text: { $prop: 'quote' } },
      }),
      node('Text', {
        box: { align: 'center' },
        props: { variant: 'meta', text: { $prop: 'author' } },
      }),
    ],
  });
...
const logoCloud = (): BuilderNode =>
  node('Section', {
    ...
    children: [
      node('Text', {
        box: { align: 'center' },
        props: { variant: 'meta', text: 'Trusted by teams everywhere' },
      }),
      node('Grid', {
  ...
  node('Section', {
    ...
    children: [
      node('Image', {
        box: {
          name: 'Feature image',
          backgroundImage: pic('feature-split', 1000, 800),
          height: 'md',
        },
      }),
      node('Stack', {
...
const ctaBanner = (): BuilderNode =>
  node('Section', {
    ...
    children: [
      node('Heading', {
        box: { align: 'center' },
        props: { level: 'h2', text: { $prop: 'heading' } },
      }),
      node('Text', {
        box: { align: 'center' },
        props: { variant: 'body', text: { $prop: 'body' } },
      }),
      node('Button', {
        props: { label: { $prop: 'buttonLabel' }, href: { $prop: 'buttonHref' }, style: 'primary' },
      }),
...
export const SPARX_DATA_COMPONENTS: DataComponentRow[] = [
  ...
  },
  {
    ...
    description:
      'A quiet, centered band for a single strong testimonial — the quote plus who said it.',
    sortWeight: 50,
  ...
  },
  {
    ...
    description:
      'A simple proof strip — a caption above a responsive row of logos. Swap in your own marks.',
    sortWeight: 44,
    tree: logoCloud(),
    propSpec: [],
  },
  {
    ...
    description:
      'Introduce the team with a responsive grid of headshot cards. Collapses gracefully on mobile.',
    sortWeight: 42,
    tree: teamGrid(),
    propSpec: [],
  },
  ...
  },
  {
    ...
    description:
      'A media-and-text feature row — image on one side, a headline, paragraph, and button on the other.',
    sortWeight: 52,
    tree: featureSplit(),
    propSpec: [
  ...
  },
  {
    ...
    description:
      'A centered subscribe band — heading, a line of copy, and a Signup form that drops subscribers straight into your CRM.',
    sortWeight: 48,
    tree: newsletterBand(),
    propSpec: [
