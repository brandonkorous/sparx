...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-retail-kitchenware-modern.ts"
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'A question about a piece, help choosing where to start, or a wedding-registry order? Tell us what you’re cooking toward and a real person at the studio will point you to the right tool — not the most expensive one.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@edgekitchen.example' }, text: 'Email the studio' }),
        ],
      }),
    ],
  }),
  ...
  },
  {
    ...
    body: {
      ...
      body: {
        type: 'doc',
        content: [
          para('A lot of kitchenware is designed for the box it’s sold in — a bright colour, a busy shape, a feature list printed on the shrink-wrap. It looks great on a shelf and wrong on your counter. We design from the other end: the tools you use most are the ones you leave out, so we make them for the counter you live with, not the cupboard they hide in.'),
