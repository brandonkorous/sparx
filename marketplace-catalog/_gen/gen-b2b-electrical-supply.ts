  ...
  el('section', 'bg-base-100 @container px-6 py-20 text-center', {
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          el('h1', 'text-5xl font-bold uppercase tracking-tight text-base-content @2xl:text-6xl', { text: 'Open a trade account' }),
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Tell us what your firm gets through and we will price your regular lines, set you up on net-30 terms, and put a name and a number to your account. Wholesale enquiries, standing orders and bulk quotes to price a job all start here.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:trade@livewiretrade.example' }, text: 'Email the trade desk' }),
        ],
      }),
    ],
  }),
...
const PRODUCTS: Product[] = [
  ...
  }),
  {
    ...
    description:
      'Integrated fire-rated LED downlights, 6 W, dimmable, IP65 for bathrooms and kitchens — a box of 10 with a 90-minute fire rating and a flush white bezel. Pick the colour temperature the room wants: warm 3000K or cool 4000K. MOQ 1 box.',
    status: 'active',
    ...
    options: [{ name: 'Colour temperature', displayType: 'dropdown', values: [{ value: 'Warm 3000K' }, { value: 'Cool 4000K' }] }],
    variants: [
      { sku: 'LWT-LGT-DL-30', priceCents: money(64), isDefault: true, inventoryPolicy: 'continue', optionValues: { 'Colour temperature': 'Warm 3000K' } },
      { sku: 'LWT-LGT-DL-40', priceCents: money(64), inventoryPolicy: 'continue', optionValues: { 'Colour temperature': 'Cool 4000K' } },
    ],
