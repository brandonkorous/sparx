...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-retail-ceramics-modern.ts"
                        ...
                        el('div', 'flex max-w-xl flex-col gap-5 rounded-box bg-base-100 p-8 @3xl:p-10', {
                            children: [
                                ...
                                el('p', 'text-lg leading-relaxed text-base-content', {
                                    text: 'Form is a contemporary ceramics studio. We make clean, quietly modern pieces for the table and the shelf — thrown and cast in small runs, glazed in three colors, and built for the dishwasher and the everyday, not the cabinet.',
                                }),
...
const HOME: Node[] = [
    ...
    editorialBand({
        heading: 'Three colors, chosen to mix',
                            ...
                            el('div', 'flex flex-col gap-2 rounded-box border border-base-300 bg-base-200 p-5', {
                                children: [
                                    ...
                                    el('p', 'text-base leading-relaxed text-base-content', {
                                        text: 'Every piece is made in a small studio batch, so stock moves and the odd color sells out for a firing or two. All of it is stoneware, fired hard and fully food-safe — microwave-safe, dishwasher-safe, and built for daily use, not the display cabinet.',
                                    }),
                                ],
                            }),
                            pdpPolicyLinks({
...
const SHOP: Node[] = [
    pageMasthead(
        'Shop',
        'The whole studio, in one place — drinkware, dinnerware, vases and pieces for the home. Filter by category or color; everything is stoneware, made in small runs and in three glazes made to be mixed.'
    ),
];
...
const SEARCH: Node[] = [
    pageMasthead('Search Form', 'Looking for a particular piece, a color, or a note from the studio? Search the whole shop and the journal below.'),
];
const CART: Node[] = [
        ...
        children: [
            el('div', 'mx-auto flex w-full max-w-5xl flex-col gap-4', {
                children: [
                    ...
                    el('p', 'max-w-2xl text-lg leading-relaxed text-base-content', {
                        text: 'Notes from the studio — how we think about form and use, what the three colors are and why they vary, and how to keep a piece looking good for years. Plain and useful, no design-world jargon.',
                    }),
                ],
            }),
        ],
        ...
        children: [
            el('div', 'mx-auto flex w-full max-w-3xl flex-col gap-6', {
                children: [
                    ...
                    el('p', 'text-lg leading-relaxed text-base-content', {
                        text: 'We design every shape in-house and make it in small studio runs, throwing and slip-casting stoneware, glazing in our three house colors and firing it hard so it stands up to daily use. Nothing is decorative-only; if a piece can’t go in the dishwasher and the microwave, we don’t make it.',
                    }),
                    el('p', 'text-lg leading-relaxed text-base-content', {
                        text: 'The look is deliberate: clean walls, honest materials, one bold color to break the quiet. We’d rather make a short list of things properly than a long catalogue of things you use twice. Buy one piece or a whole table — either way it’s made to last.',
                    }),
                ],
            }),
        ],
...
const CONTACT: Node[] = [
    ...
    contactSection({
        heading: 'Say hello',
        intro: 'A question about a piece, a custom order for your restaurant or shop, or a wholesale enquiry? Tell us what you have in mind and one of us — the people who design and make the work — will write back.',
...
// Color is the natural per-piece choice — three house glazes, shown as swatches. Every piece
...
const PRODUCTS: Product[] = [
    piece({
        ...
        seoDescription: 'A straight-sided 11oz mug with a clean rim and a small handle. Matte outside, gloss well. Three colors.',
    }),
    piece({
        ...
        seoDescription: 'Three graduating coupe bowls that nest to one, for cereal, sides and prep. A set of three in three colors.',
    }),
    piece({
        handle: 'coupe-plates',
        ...
        seoDescription: 'Four rimless 10" coupe dinner plates, fully glazed and made to stack. A set of four in three house colors.',
    }),
    piece({
        ...
        seoDescription: 'A slim bedside carafe with a matching cup lid, balanced to pour one-handed and drip-free. Three colors.',
    }),
    piece({
        handle: 'tumbler-set',
        title: 'Tumbler Set',
        ...
        seoDescription: 'Four straight-walled stoneware tumblers for water, wine or juice, made to stack. A set of four in three colors.',
    }),
    piece({
        handle: 'arc-vase',
        title: 'Arc Vase',
        ...
        seoDescription: 'A sculptural vase with a wide sweeping opening, weighted low for stems or shown empty. Matte, in three colors.',
    }),
    piece({
        handle: 'column-vase',
        title: 'Column Vase',
        ...
        seoDescription: 'A tall narrow column vase for a single stem or shown empty, with a crisp slip-cast wall. Three colors.',
    }),
    piece({
        ...
        seoDescription: 'A clean cylinder planter with a drop-in drainage pot and glazed outer, sized for a 6" grower. Three colors.',
    }),
    piece({
        handle: 'table-set',
        title: 'The Table Set',
        ...
        seoDescription: 'A six-piece table set for two — two plates, two bowls, two mugs, made in one run to match. In three colors.',
    }),
];
...
const CONTENT = [
    ...
    {
        typeKey: 'blog_post',
        slug: 'the-three-colors',
        status: 'published',
        body: {
            title: 'The three colors, and why they vary',
            ...
            body: {
                type: 'doc',
                content: [
                    para('We keep the palette deliberately short: one soft white, one cool grey, one warm accent. Three colors is enough to build a whole table and few enough that everything we make is guaranteed to mix. But a glaze isn’t paint — it’s a coat of minerals that only becomes its final color in the heat of the kiln, and small things change how it lands.'),
...
const SPEC: TemplateSiteSpec = {
    ...
    seo: {
        home: {
            ...
            description:
                'Form is a contemporary ceramics studio making clean, modern stoneware for the table and the home — mugs, bowls, plates, vases and planters, each made in small runs in three house colors.',
        },
        about: {
            title: 'About Form',
            description:
                'A contemporary ceramics studio: how Form designs and makes clean, modern stoneware in small runs — simple forms, three house colors, built for daily use, not the display cabinet.',
        },
    },
    home: HOME,
    shop: SHOP,
