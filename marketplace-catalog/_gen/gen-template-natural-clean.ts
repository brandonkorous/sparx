...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-natural-clean.ts"
 ...
 *  is a filled `<a>` whose label rides the fill's own paired on-color, so it stays
 ...
 *  color on this page is carried by the category tiles, the primary actions and the
...
const PRODUCTS: Product[] = [
    {
        ...
        options: [
            { name: 'Color', displayType: 'swatch', values: [{ value: 'Natural' }, { value: 'Sage' }] },
        ],
        variants: [
            { sku: 'FWD-DISHTOWEL-NAT', priceCents: money(24), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Natural' } },
            { sku: 'FWD-DISHTOWEL-SAG', priceCents: money(24), inventoryPolicy: 'continue', optionValues: { Color: 'Sage' } },
        ],
    ...
    },
    {
        ...
        options: [
            { name: 'Color', displayType: 'swatch', values: [{ value: 'Oat' }, { value: 'Clay' }] },
        ],
        variants: [
            { sku: 'FWD-TEATOWEL-OAT', priceCents: money(22), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Oat' } },
            { sku: 'FWD-TEATOWEL-CLA', priceCents: money(22), inventoryPolicy: 'continue', optionValues: { Color: 'Clay' } },
        ],
    ...
    },
    {
        ...
        attributes: {
            ...
            fit: 'A set of four, each holding a proper amount of coffee; because they are glazed by hand, the color varies a little cup to cup. Sized for everyday use, not a display shelf.',
        ...
        options: [
            { name: 'Color', displayType: 'swatch', values: [{ value: 'Oatmeal' }, { value: 'Clay' }] },
        ],
        variants: [
            { sku: 'FWD-MUG-OAT', priceCents: money(44), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Oatmeal' } },
            { sku: 'FWD-MUG-CLA', priceCents: money(44), inventoryPolicy: 'continue', optionValues: { Color: 'Clay' } },
        ],
    ...
    },
    {
        ...
        description:
            'A pair of bath towels woven from long-staple organic cotton, thirsty from the first wash rather than the tenth and free of the softening coatings that stop cheaper towels absorbing at all. Undyed or colored with low-impact dye, hemmed to hold their shape, and the kind of everyday thing worth buying once and keeping.',
        status: 'active',
        ...
        attributes: {
            fabric:
                'Woven from long-staple organic cotton, thirsty from the first wash rather than the tenth and free of the softening coatings that stop cheaper towels absorbing. Undyed or colored with low-impact dye, and hemmed to hold their shape.',
        ...
        options: [
            { name: 'Color', displayType: 'swatch', values: [{ value: 'Oat' }, { value: 'Slate' }] },
        ],
        variants: [
            { sku: 'FWD-BATHTOWEL-OAT', priceCents: money(42), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Oat' } },
            { sku: 'FWD-BATHTOWEL-SLT', priceCents: money(42), inventoryPolicy: 'continue', optionValues: { Color: 'Slate' } },
        ],
