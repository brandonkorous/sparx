...
// product art carries the color, and the studio's store is one click away.
//
...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-brand-newsroom.ts"
...
//
// DARK-THEME DISCIPLINE. The `console` theme is a true-dark ground, but every color here
