...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-b2b-restaurant-equipment.ts"
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Tell us what your kitchen goes through and we will price your regular lines, set you up on net-30 terms, and put a name and a number to your account. Fit-out quotes, standing orders and multi-location supply all start here.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:trade@passsupply.example' }, text: 'Email the trade desk' }),
        ],
      }),
    ],
  }),
