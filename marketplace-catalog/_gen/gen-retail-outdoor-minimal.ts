...
const CONTACT: Node[] = [
  ...
  contactSection({
    ...
    intro: 'Questions about fit, a colour, a repair or an order? Tell us what you’re after and a real person who wears the pieces will get back to you — usually within a day.',
