...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-salon-modern.ts"
...
const ASSETS: Asset[] = [
  ...
  { id: IMG.juniper, url: src('wildroot-juniper'), alt: 'Juniper Vale, colour specialist' },
...
const SCHEDULING = {
  policies: [
    ...
    },
    {
      ...
      policyText:
        'Colour and balayage hold a $30 deposit that comes straight off your total. Move your appointment with 48 hours’ notice and it carries right over.',
    },
  ],
  resources: [
    {
    ...
    },
    {
      ...
      name: 'Juniper Vale',
      kind: 'staff',
      skillTags: ['cut', 'colour', 'balayage', 'gloss', 'treatment'],
    ...
    },
    {
      ...
      name: 'Marisol Reyes',
      kind: 'staff',
      skillTags: ['cut', 'curly', 'colour', 'styling', 'kids'],
  ...
  services: [
    ...
    },
    {
      handle: 'colour',
      name: 'Colour',
      description: 'Single-process colour, root to tip, finished with a gloss so it leaves shiny and even.',
      durationMinutes: 120,
      priceCents: 14000,
      bufferAfterMin: 15,
      assignmentStrategy: 'customer_choice',
      resourceRequirements: [{ role: 'colourist', kind: 'staff', skillTags: ['colour'], count: 1 }],
      policyHandle: 'colour-deposit',
    },
    {
      handle: 'balayage',
      ...
      bufferAfterMin: 15,
      assignmentStrategy: 'customer_choice',
      resourceRequirements: [{ role: 'colourist', kind: 'staff', skillTags: ['balayage'], count: 1 }],
      policyHandle: 'colour-deposit',
    },
    {
      handle: 'gloss-toner',
      name: 'Gloss & toner',
      description: 'A quick shine-and-tone refresh to keep your colour looking new between visits.',
      durationMinutes: 45,
      priceCents: 6000,
      bufferAfterMin: 10,
      assignmentStrategy: 'any_available',
      resourceRequirements: [{ role: 'colourist', kind: 'staff', skillTags: ['gloss'], count: 1 }],
      policyHandle: 'salon-standard',
    },
    {
      handle: 'treatment',
...
const HOME = [
  photoHero({
    ...
    sub: 'A warm, plant-filled little salon for real hair and real people — cuts, colour and curls done at a human pace, never a rushed one.',
  ...
  serviceMenu({
    ...
    items: [
      ...
      { name: 'Colour', priceCents: 14000, durationMin: 120, desc: 'Root-to-tip colour finished with a gloss.' },
    ],
  ...
  teamRow({
    ...
    members: [
      ...
      { name: 'Juniper Vale', role: 'Colour specialist', image: url(IMG.juniper), alt: 'Juniper Vale, colour specialist', bio: 'Balayage, lived-in colour and glosses that grow out soft and low-upkeep.' },
      { name: 'Marisol Reyes', role: 'Stylist', image: url(IMG.marisol), alt: 'Marisol Reyes, stylist', bio: 'Easy, wearable cuts and colour — and endlessly patient with the little ones.' },
    ],
  }),
  galleryStrip({
...
const ABOUT = [
  splitFeature({
    ...
    body: [
      ...
      'No upselling, no rushing, no leaving with a look you can’t recreate. Just honest cuts, soft colour, a lot of plants, and an hour that’s genuinely yours.',
    ],
  ...
  featureRow({
    ...
    items: [
      ...
      { title: 'Gentle, good products', body: 'Salon-grade, kinder-on-your-hair colour and care — and honest advice on the short list of things worth taking home.' },
...
const SPEC: ServiceSiteSpec = {
  ...
  seo: {
    home: {
      ...
      description:
        'Wildroot is a warm, plant-filled salon in Asheville specialising in curly and textured hair — cuts, colour and balayage at a human pace. Book your stylist online.',
    },
  },
  home: HOME,
