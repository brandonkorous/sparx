    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Questions about a piece, help planning a room, or a trade and interiors enquiry? Tell us what you’re after and a real person here will get back to you — usually within a day.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@formandfield.example' }, text: 'Email us' }),
        ],
      }),
    ],
  }),
