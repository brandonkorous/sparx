...
// header for why). Run:
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-portfolio-developer.ts"
...
// `bg-base-200` shift + a border, never a gradient or a glow. No hardcoded colours.
//
    ...
    body: {
      ...
      body: {
        ...
        content: [
          ...
          h2('What it is'),
          para('It started as a demo for a music-visualiser pitch and turned into a small engine. Points flow through an animated noise field; the cursor drags a well through them; colour is driven by velocity. It’s the kind of thing that looks like a screensaver until you realise every point is a live simulation, not a video.'),
          h2('The hard part'),
    ...
    body: {
      ...
      body: {
        ...
        content: [
          ...
          h2('What it is'),
          para('Learning shaders is brutal because the feedback loop is broken: you write maths that describes a colour per pixel, and a typo gives you either a black screen or a cryptic driver error with no line number. Prism closes that loop — every keystroke recompiles the shader and either shows the result or points at the exact line that broke.'),
          h2('The hard part'),
