...
const CONTACT: Node[] = [
  ...
  contactSection({
    ...
    intro: 'A tip, a correction, or a story we should be chasing? We read everything, and we protect our sources. Encrypted contact details are on every reporter’s page.',
    submitLabel: 'Email the newsroom',
  }),
];
