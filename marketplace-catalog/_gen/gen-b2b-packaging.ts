...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-b2b-packaging.ts"
          ...
          el('div', 'grid grid-cols-1 gap-4 @3xl:grid-cols-3 @3xl:gap-6', {
            children: [
              ...
              tradeCard({
                ...
                body: 'Put your brand on the box: one to two colours on cartons, mailers and tape, from low trade minimums. Send artwork and we quote the run and the lead time back the same week.',
              }),
              tradeCard({
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Tell us what you ship and roughly how much, and we will set up an account with your trade pricing, net-30 terms and a named account manager — usually within a day. Existing customers, reach your manager on the direct line on your statement.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:trade@boxwellsupply.example' }, text: 'Email the trade desk' }),
        ],
      }),
    ],
  }),
