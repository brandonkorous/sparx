...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-tech-cinematic.ts"
...
const HOME: Node[] = [
  ...
  capabilityBand({
    ...
    lead: 'We start from the recording and work backwards — a signature that adds no colour of its own, so a voice sounds like the person and a room sounds like the room. What the artist meant, and not a hair more.',
    assetId: 'band-sound',
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'A question about which pair suits your music, a room you want to fill, or a piece that needs a part after a few good years — a real person who knows the gear reads every message and replies, usually the same day.',
          }),
          el('a', 'btn btn-primary btn-lg', {
            attrs: { href: 'mailto:hello@aphelion.example' },
            text: 'Email Aphelion',
          }),
        ],
      }),
    ...
    body: {
      ...
      body: {
        ...
        content: [
          ...
          para('We voice the Monolith flat, because a coloured speaker flatters some records and wrecks others — and once the colour is baked in you cannot take it back out. Flat means a well-made recording sounds thrilling and a badly-made one sounds honest about it, which is the speaker telling you the truth rather than a lie you happen to like.'),
