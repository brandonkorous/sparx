...
// cut-and-colour) and the barbershops (dark heritage): a different business on the same
// booking spine — massage, facials, body work and quiet time in the sauna.
//
// This file is JUST the SPEC; composition + emission + the section kit live in the shared
// service-sites/harness.ts. Run:
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-dayspa-botanical.ts"
