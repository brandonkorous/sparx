...
// display over clean Inter body, zero radius — the photograph supplies every colour).
//
...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-glossy-fashion.ts"
...
const PRODUCTS: Product[] = [
  {
    ...
    description:
      'A generous square of heavyweight silk twill, hand-rolled at the edge, in a single quiet colour. The one accessory the wardrobe story kept coming back to — it finishes a coat and asks for nothing.',
    status: 'active',
    ...
    seoDescription: 'A heavyweight silk twill scarf in a single quiet colour, hand-rolled at the edge.',
  ...
  },
  {
    ...
    body: {
      ...
      body: {
        type: 'doc',
        content: [
          para('Backstage this season the instruction to the artists was the same everywhere, in three or four languages: less. Less product, less colour, less of the face doing the work the clothes were supposed to do. The result reads, from the front row, as skin — and almost nothing else.'),
