...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-painting-premium.ts"
    ...
    services: [
        {
            ...
            description:
                'A complimentary walk-through of your rooms to talk through color, finish and how we can help.',
            durationMinutes: 45,
            priceCents: 0,
