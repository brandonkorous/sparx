    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'A question about a grade, a wholesale enquiry, or want us to blend for your café or studio? Tell us what you’re after and a real person at Matcha Club will get back to you.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@matchaclub.example' }, text: 'Email the club' }),
        ],
      }),
    ],
  }),
