...
//
// The beauty counter translated to sparx: an own-brand color-cosmetics house where the
...
//
// Shade ranges are presented STATICALLY: every color product declares a `Shade` SWATCH
...
const PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        description:
            'A retractable lip liner with a fine, creamy tip that draws a clean edge and fills the whole lip to make color last. Ten shades built to match the liquid lip, or to define on their own.',
        status: 'active',
