...
// color & layout help and shoppable design boards for everyday homeowners — not a
...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-interior-edesign.ts"
...
const ASSETS: Asset[] = [
    ...
    { id: IMG.approach, url: src('roomco-approach'), alt: 'A color-and-fabric moodboard laid out on a sunny table' },
...
const HOME = [
    ...
    serviceMenu({
        ...
        items: [
            ...
            { name: 'Color consult', priceCents: 12900, durationMin: 45, desc: 'Paint and palette that work in your light.' },
        ],
