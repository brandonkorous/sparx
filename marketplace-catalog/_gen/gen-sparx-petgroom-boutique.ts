...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-petgroom-boutique.ts"
...
const SCHEDULING = {
  ...
  services: [
    ...
    },
    {
      ...
      description:
        'Traditional hand-stripping for wire-coated breeds — pulling, not clipping, to keep colour and texture true. Patient, careful, and kind to the coat.',
      durationMinutes: 150,
      priceCents: 16500,
      bufferAfterMin: 15,
      assignmentStrategy: 'customer_choice',
