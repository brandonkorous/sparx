...
// carry all the color. Dressed in the bespoke `silver` theme (a cool gallery-white paper, a
...
// micro-label ink (a caption, a date, a location). No hardcoded colors — surfaces separate by
 ...
 *  contact page. Restraint, not a colored call-to-action band. */
