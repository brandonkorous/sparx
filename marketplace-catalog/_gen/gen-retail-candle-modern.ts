...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-retail-candle-modern.ts"
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Questions about a scent, a refill, or a wholesale order for your shop or hotel? Tell us what you’re after and a real person at the studio will write back.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@lumengoods.example' }, text: 'Email the studio' }),
        ],
      }),
    ],
  }),
