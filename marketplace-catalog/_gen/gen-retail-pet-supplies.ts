    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Not sure which size collar fits, need a hand choosing a bed, or want to talk about stocking Barkwell in your shop? Tell us about your dog and a real person here — usually with a dog at their feet — will get back to you within a day.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@barkwell.example' }, text: 'Email us' }),
        ],
      }),
    ],
  }),
