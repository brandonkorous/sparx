    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Chasing a title, planning an event, or stuck on a gift for someone impossible to buy for? Tell us what you’re after and a real bookseller will write back — recommending books is genuinely our favourite part.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@volumebooks.example' }, text: 'Email the shop' }),
        ],
      }),
    ],
  }),
