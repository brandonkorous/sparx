...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-retail-bookstore-modern.ts"
...
const ASSETS: Asset[] = [
    ...
    { id: 'vol-tile-fiction', url: src('vol-tile-fiction'), alt: 'A tidy shelf of fiction with colorful modern spines' },
