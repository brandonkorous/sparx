...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-dental-family.ts"
...
const HOME = [
    ...
    serviceMenu({
        ...
        items: [
            ...
            { name: 'Filling', priceCents: 18500, durationMin: 60, desc: 'A comfortable, tooth-colored fix for a small cavity.' },
