...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-florist-shop.ts"
  ...
  services: [
    {
      ...
      description:
        'A quick, no-pressure chat about what you need — an occasion, a budget, a favourite colour — and we’ll point you the right way.',
      durationMinutes: 20,
      priceCents: 0,
    ...
    items: [
      {
        ...
        priceCents: 0,
        durationMin: 20,
        desc: 'A quick chat about your occasion, budget and colours.',
      },
      {
        name: 'Custom arrangement consult',
        priceCents: 2500,
  ...
  teamRow({
    ...
    members: [
      ...
      },
      {
        ...
        bio: 'Runs the potting-table workshops and never met a colour combination she wouldn’t try.',
      },
      {
        name: 'Dahlia Okafor',
