    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'A question about a flavour, a big order for a party or a wedding, or want a custom box with your colours on it? Tell us what you’re dreaming up and a real person at the kitchen will get right back to you.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@sweettoothco.example' }, text: 'Email the kitchen' }),
        ],
      }),
    ],
  }),
