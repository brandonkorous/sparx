...
// the primary action. The look is DARK, but every colour is a SEMANTIC token — the dark
// ground is `bg-base-100`, the light ink `text-base-content`, the hot accent `text-primary` —
// so a tenant that recolours the theme recolours the whole site and nothing is hardcoded.
...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-culture-bold.ts"
