    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'A question about an origin, a corporate gifting order, or want us to make something for your wedding or event? Tell us what you’re after and a real person at the workshop will get back to you.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@cacaoandco.example' }, text: 'Email the workshop' }),
        ],
      }),
    ],
  }),
