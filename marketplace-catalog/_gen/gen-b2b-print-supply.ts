...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-b2b-print-supply.ts"
...
const ASSETS: Asset[] = [
    ...
    { id: 'print-tile-vinyl', url: src('print-tile-vinyl'), alt: 'Rolls of colored cast vinyl and heat-transfer film on a shelf' },
...
const PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        options: [{ name: 'Color', displayType: 'dropdown', values: [{ value: 'White' }, { value: 'Black' }, { value: 'Red' }] }],
        variants: [
            { sku: 'IYD-HTV-PU-20-W', priceCents: money(34), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'White' } },
            { sku: 'IYD-HTV-PU-20-K', priceCents: money(34), inventoryPolicy: 'continue', optionValues: { Color: 'Black' } },
            { sku: 'IYD-HTV-PU-20-R', priceCents: money(37), inventoryPolicy: 'continue', optionValues: { Color: 'Red' } },
        ],
    ...
    unitItem({
        ...
        seoDescription: 'Four-color CMYK eco-solvent ink set, 440 mL cartridges. Weatherproof, profiled for banner, vinyl and film.',
    }),
    unitItem({
        ...
        seoDescription: 'Four-color CMYK dye-sublimation ink set, 1 L bottles. High yield, sharp gradients, even sublimation.',
    }),
    {
        ...
        seoDescription: 'White polymer-coated ceramic sublimation blank mugs, case of 36. Even coating, full-wrap, wash-durable color. 11oz or 15oz.',
