  ...
  el('section', 'bg-base-100 @container px-6 py-20 text-center', {
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          el('h1', 'text-5xl font-normal tracking-tight text-base-content @2xl:text-6xl', { text: 'Come say hello' }),
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Chasing a title, selling a collection, or want us to spin something at your do? Tell us what you’re after and a real person behind the counter will write back.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@sunsetsounds.example' }, text: 'Email the shop' }),
        ],
      }),
    ],
  }),
