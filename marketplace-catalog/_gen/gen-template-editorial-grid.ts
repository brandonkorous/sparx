...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-editorial-grid.ts"
...
const PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        variants: [
            { sku: 'ATN-THROW-OAT', priceCents: money(190), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Oat' } },
            { sku: 'ATN-THROW-SLT', priceCents: money(190), inventoryPolicy: 'continue', optionValues: { Color: 'Slate' } },
        ],
    ...
    },
    {
        ...
        attributes: {
            ...
            dimensions: '50 × 50 cm',
            care: 'Unzip and dry-clean the cover; plump and rotate the down pad to keep its loft. Shake it out rather than beating it, and keep it clear of long direct sun so the color holds.',
            origin: 'Made in the United Kingdom',
        },
        options: [
            { name: 'Color', displayType: 'swatch', values: [{ value: 'Rust' }, { value: 'Sand' }] },
        ],
        variants: [
            { sku: 'ATN-CUSHION-RST', priceCents: money(110), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Rust' } },
            { sku: 'ATN-CUSHION-SND', priceCents: money(110), inventoryPolicy: 'continue', optionValues: { Color: 'Sand' } },
        ],
