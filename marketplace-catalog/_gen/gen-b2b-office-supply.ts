...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-b2b-office-supply.ts"
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Tell us what your office goes through and we will price your regular lines, set you up on net-30 terms, and put a name and a number to your account. Wholesale enquiries, standing orders and bulk quotes for procurement all start here.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:trade@worksmithsupply.example' }, text: 'Email the trade desk' }),
        ],
      }),
    ],
  }),
...
const PRODUCTS: Product[] = [
  ...
  }),
  {
    ...
    description:
      'A breathable mesh-back task chair with adjustable lumbar, seat height and armrests — the chair a team can sit in for eight hours without a physio bill. Ships one to a carton, assembled in minutes. MOQ 4 chairs — enough to fit out a room. Pick the frame colour.',
    status: 'active',
    productType: 'Furniture',
    vendor: VENDOR,
    ...
    options: [{ name: 'Colour', displayType: 'dropdown', values: [{ value: 'Black' }, { value: 'Grey' }] }],
    variants: [
      { sku: 'WSS-FUR-CHAIR-BLK', priceCents: money(139), isDefault: true, inventoryPolicy: 'continue', optionValues: { Colour: 'Black' } },
      { sku: 'WSS-FUR-CHAIR-GRY', priceCents: money(139), inventoryPolicy: 'continue', optionValues: { Colour: 'Grey' } },
    ],
