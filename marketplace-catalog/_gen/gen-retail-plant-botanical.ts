    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'A droopy leaf you can’t diagnose, a question before you buy, or a big order for an office or a wedding? Send a photo or a note and a real person at the nursery will help — we love a plant-doctor puzzle.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@fernwoodplants.example' }, text: 'Email the nursery' }),
        ],
      }),
    ],
  }),
