    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Styling a corner and not sure what fits, planning plants for an office or a project, or want a piece you can’t see here? Send a photo of the space and a note — a real person at the studio will help you compose it.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:studio@frondplants.example' }, text: 'Email the studio' }),
        ],
      }),
    ],
  }),
