...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-optometry-boutique.ts"
    ...
    featureRow({
        items: [
            ...
            },
            {
                ...
                body: 'A stylist pulls frames for your face shape, coloring and how you actually live, so you leave with a pair you reach for.',
            },
            {
