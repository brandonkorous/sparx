...
const ASSETS: Asset[] = [
  ...
  { id: IMG.del, url: src('ironwood-del'), alt: 'Del Marrow, fine-line and colour artist' },
...
const SCHEDULING = {
  ...
  resources: [
    ...
    },
    {
      ...
      name: 'Del Marrow',
      kind: 'staff',
      skillTags: ['fineline', 'colour', 'traditional'],
    ...
    },
    {
      ...
      name: 'June Okonkwo',
      kind: 'staff',
      skillTags: ['realism', 'colour', 'blackwork'],
...
const HOME = [
  ...
  teamRow({
    ...
    members: [
      ...
      {
        name: 'Del Marrow',
        role: 'Fine-line & colour',
        image: url(IMG.del),
        alt: 'Del Marrow, fine-line and colour artist',
        bio: 'Single-needle script, botanicals and quiet, precise colour.',
      },
      {
        name: 'June Okonkwo',
