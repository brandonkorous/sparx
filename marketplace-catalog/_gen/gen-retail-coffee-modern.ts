...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-retail-coffee-modern.ts"
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Questions about a coffee, help dialing in your brewer, a wholesale enquiry, or want us to roast for your café? Tell us what you’re after and a real person at the roastery will get back to you.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@meridiancoffee.example' }, text: 'Email the roastery' }),
        ],
      }),
    ],
  }),
