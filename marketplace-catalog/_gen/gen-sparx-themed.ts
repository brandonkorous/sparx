 ...
 *  the ingest resolves this module with no workspace resolution). Prettier reformats
...
// generator and regenerate. A blueprint is PURE DATA: the ingest \`import()\`s this module
