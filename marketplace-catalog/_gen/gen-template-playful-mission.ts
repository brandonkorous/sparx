...
//
// Bombas translated to sparx: a playful, colourful, mission-driven DTC storefront whose
...
// fully-saturated colour bands (marigold giveback, navy impact, sage "the rest") so
...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-playful-mission.ts"
...
// installer re-hosts them); the hero / colour-tile / editorial-band photos are TREE
...
const IMG = {
  ...
  // Colour-block category tiles (tree imagery)
...
/** The signature colour-block category tiles — four full-bleed photo tiles a visitor taps
 ...
 *  through the theme's four band colours (marigold / navy / sage / charcoal) so the strip
 *  reads as the joyful picture-book colour Bombas is built on. Named utilities throughout. */
 ...
 *  ground (the "ONE PURCHASED = ONE DONATED" headline). A colour band this archetype
 ...
 *  (the marigold "200 MILLION+ DONATIONS" band, recoloured navy so the page carries three
...
const PRODUCTS: Product[] = [
  {
    ...
    variants: [
      { sku: 'RLY-BED-BOL-S', priceCents: money(89), inventoryPolicy: 'continue', optionValues: { Size: 'Small', Colour: 'Oatmeal' } },
      { sku: 'RLY-BED-BOL-M', priceCents: money(119), isDefault: true, inventoryPolicy: 'continue', optionValues: { Size: 'Medium', Colour: 'Oatmeal' } },
      { sku: 'RLY-BED-BOL-L', priceCents: money(149), inventoryPolicy: 'continue', optionValues: { Size: 'Large', Colour: 'Oatmeal' } },
    ],
  ...
  },
  {
    ...
    variants: [
      { sku: 'RLY-BED-DON-CRM', priceCents: money(54), isDefault: true, inventoryPolicy: 'continue', optionValues: { Colour: 'Cream' } },
      { sku: 'RLY-BED-DON-GRY', priceCents: money(54), inventoryPolicy: 'continue', optionValues: { Colour: 'Grey' } },
      { sku: 'RLY-BED-DON-BLS', priceCents: money(54), inventoryPolicy: 'continue', optionValues: { Colour: 'Blush' } },
    ],
  ...
  },
  {
    ...
    variants: [
      { sku: 'RLY-BLK-FLC-OAT', priceCents: money(32), isDefault: true, inventoryPolicy: 'continue', optionValues: { Colour: 'Oat' } },
      { sku: 'RLY-BLK-FLC-CHR', priceCents: money(32), inventoryPolicy: 'continue', optionValues: { Colour: 'Charcoal' } },
      { sku: 'RLY-BLK-FLC-RST', priceCents: money(32), inventoryPolicy: 'continue', optionValues: { Colour: 'Rust' } },
      { sku: 'RLY-BLK-FLC-SGE', priceCents: money(32), inventoryPolicy: 'continue', optionValues: { Colour: 'Sage' } },
    ],
  ...
  },
  {
    ...
    variants: [
      { sku: 'RLY-LED-REF-MAR', priceCents: money(29), isDefault: true, inventoryPolicy: 'continue', optionValues: { Colour: 'Marigold' } },
      { sku: 'RLY-LED-REF-NVY', priceCents: money(29), inventoryPolicy: 'continue', optionValues: { Colour: 'Navy' } },
      { sku: 'RLY-LED-REF-SGE', priceCents: money(29), inventoryPolicy: 'continue', optionValues: { Colour: 'Sage' } },
      { sku: 'RLY-LED-REF-CRL', priceCents: money(29), inventoryPolicy: 'continue', optionValues: { Colour: 'Coral' } },
      { sku: 'RLY-LED-REF-CHR', priceCents: money(29), inventoryPolicy: 'continue', optionValues: { Colour: 'Charcoal' } },
    ],
  ...
  },
  {
    ...
    variants: [
      { sku: 'RLY-BWL-SET-MAR', priceCents: money(42), isDefault: true, inventoryPolicy: 'continue', optionValues: { Colour: 'Marigold' } },
      { sku: 'RLY-BWL-SET-SGE', priceCents: money(42), inventoryPolicy: 'continue', optionValues: { Colour: 'Sage' } },
      { sku: 'RLY-BWL-SET-CRM', priceCents: money(42), inventoryPolicy: 'continue', optionValues: { Colour: 'Speckled Cream' } },
    ],
...
//
// CONTRAST NOTE. Marigold `primary` is a FILL colour on this theme — as TEXT on the cream
 ...
 *  home page paces its colour bands. In place of the generic "Shop / Everything we have". */
const SHOP: Node[] = [
...
const SEARCH: Node[] = [
  pageMasthead(
    'Find it fast',
    'After a specific size, a colour, a treat your dog goes daft for? Search the whole shop and the Journal below — and remember, whatever you turn up, buying it sends a match to a shelter animal too.'
  ),
];
