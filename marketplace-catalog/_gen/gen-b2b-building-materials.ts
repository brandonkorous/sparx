...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-b2b-building-materials.ts"
...
const PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        options: [
            { name: 'Color', displayType: 'dropdown', values: [{ value: 'Clear' }, { value: 'White' }, { value: 'Grey' }, { value: 'Brown' }] },
        ],
        variants: [
            { sku: 'YRD-FIX-SIL-CL', priceCents: money(42), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Clear' } },
            { sku: 'YRD-FIX-SIL-WH', priceCents: money(42), inventoryPolicy: 'continue', optionValues: { Color: 'White' } },
            { sku: 'YRD-FIX-SIL-GR', priceCents: money(44), inventoryPolicy: 'continue', optionValues: { Color: 'Grey' } },
            { sku: 'YRD-FIX-SIL-BR', priceCents: money(44), inventoryPolicy: 'continue', optionValues: { Color: 'Brown' } },
        ],
