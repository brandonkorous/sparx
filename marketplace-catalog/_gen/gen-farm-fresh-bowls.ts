// ENTRY for the farm-fresh-bowls blueprint generator (docs/guides/building-a-template.md
...
// locations + catering + product & post templates), and a welcome email.
//
// This file is THIN by design: the authoring vocabulary is split into the
// ./farm-fresh-bowls/ module folder (one cohesive concern per file — _kit, theme, media,
...
//   npx prettier --write "marketplace-catalog/blueprints/farm-fresh-bowls/**/*.ts"
//
...
import { emitBundle } from './farm-fresh-bowls/emit';
import { manifest } from './farm-fresh-bowls/manifest';

const here = dirname(fileURLToPath(import.meta.url)); // marketplace-catalog/_gen
const bundleDir = join(here, '..', 'blueprints', 'farm-fresh-bowls');
