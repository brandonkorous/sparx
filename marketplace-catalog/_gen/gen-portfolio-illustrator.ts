...
// header for why). Run:
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-portfolio-illustrator.ts"
...
// `btn-primary`) and cobalt (`text-accent` / `btn-accent`). No hardcoded colors, no gradients,
 ...
 *  one-liner, and two actions. No image: the type + the color do all the shouting. */
