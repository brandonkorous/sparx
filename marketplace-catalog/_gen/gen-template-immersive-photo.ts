...
// a near-black photographic ground where the image carries all the color, one bright
...
// reference's caption-on-scrim, translated to a rule the sweep can pass. Color comes
// from the photographs; the ONE non-photographic color is the amber `text-primary` rule.
//
...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-immersive-photo.ts"
 ...
 *  all the color; the rubric + headline + dek + byline sit in a SOLID `bg-base-100` panel
                            ...
                            el('div', 'flex max-w-xl flex-col gap-4 rounded-box bg-base-100 p-8 @2xl:p-10', {
                                children: [
                                    ...
                                    el('p', 'text-lg leading-relaxed text-base-content', {
                                        text: 'The driest desert on Earth turns to color for a few minutes at dusk. We drove four hours for those minutes, and stayed for the sky that came after.',
                                    }),
...
const CONTENT = [
    {
        ...
        body: {
            ...
            excerpt:
                'The driest desert on Earth turns to color for a few minutes at dusk. We drove four hours for those minutes, and stayed for the sky that came after.',
