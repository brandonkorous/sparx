...
const ASSETS: Asset[] = [
  ...
  { id: IMG.noor, url: src('maison-noor'), alt: 'Noor Rahim, colour specialist' },
...
const SCHEDULING = {
  policies: [
    ...
    },
    {
      ...
      policyText:
        'Colour appointments hold a $25 deposit that comes off your total. Reschedule with 48 hours’ notice and it carries over.',
    },
  ],
  resources: [
    {
      ...
      name: 'Ava Bennett',
      kind: 'staff',
      skillTags: ['cut', 'colour', 'styling', 'treatment', 'balayage'],
    ...
    },
    {
      ...
      name: 'Noor Rahim',
      kind: 'staff',
      skillTags: ['colour', 'balayage', 'treatment'],
  ...
  services: [
    ...
    },
    {
      handle: 'gloss-toner',
      name: 'Gloss & toner',
      description: 'A shine-boosting gloss to refresh tone between colour appointments.',
      durationMinutes: 60,
      priceCents: 7500,
      bufferAfterMin: 10,
      assignmentStrategy: 'customer_choice',
    ...
    },
    {
      handle: 'full-colour',
      name: 'Full colour',
      description: 'Single-process colour, root to tip, with a gloss and a finish.',
      durationMinutes: 120,
      priceCents: 16000,
      bufferAfterMin: 15,
      assignmentStrategy: 'customer_choice',
...
const HOME = [
  photoHero({
    ...
    sub: 'A calm studio for considered cuts, soft lived-in colour and the kind of finish that lasts past the front door.',
  ...
  featureRow({
    items: [
      ...
      {
        title: 'Colour that grows out kindly',
        body: 'Soft, hand-placed colour designed for low upkeep — so you leave less often and love it longer.',
      },
      {
  ...
  serviceMenu({
    ...
    items: [
      ...
      { name: 'Full colour', priceCents: 16000, durationMin: 120, desc: 'Root-to-tip colour with a gloss.' },
  ...
  teamRow({
    ...
    members: [
      { name: 'Ava Bennett', role: 'Senior stylist', image: url(IMG.ava), alt: 'Ava Bennett, senior stylist', bio: 'Precision cuts and quiet-luxury colour. Ava leads the studio.' },
      ...
      { name: 'Noor Rahim', role: 'Colour specialist', image: url(IMG.noor), alt: 'Noor Rahim, colour specialist', bio: 'Balayage and lived-in colour that grows out beautifully.' },
    ],
  }),
  galleryStrip({
    heading: 'Recent work',
...
const ABOUT = [
  splitFeature({
    ...
    body: [
      ...
      'No upselling, no rushing, no leaving with a look you can’t recreate. Just considered cuts, soft colour and a calm hour that’s genuinely yours.',
    ],
  ...
  featureRow({
    ...
    items: [
      ...
      { title: 'Products we believe in', body: 'Gentle, salon-grade colour and care — and honest advice on the short list of things worth taking home.' },
...
const SPEC: ServiceSiteSpec = {
  ...
  seo: {
    home: {
      ...
      description:
        'Maison Élan is a calm three-chair salon for considered cuts, soft lived-in colour and balayage. Book your stylist online.',
    },
  },
  home: HOME,
