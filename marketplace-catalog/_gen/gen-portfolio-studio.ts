...
// large-format work is the colour, the chassis stays quiet.
//
...
// (`text-accent`) reserved for the facts. No hardcoded colours — surfaces separate by a
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-5xl flex-col gap-12', {
        children: [
          ...
          // secondary micro-label ink, values in the cool slate accent (the facts colour).
