...
// nav). Run:
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-restaurant-vegan.ts"
...
const ASSETS: Asset[] = [
  ...
  { id: 'sprout-dish-1', url: src('sprout-dish-1'), alt: 'A colourful roasted-vegetable bowl with grains, herbs and a bright green dressing' },
            ...
            el('div', 'flex max-w-xl flex-col gap-5 rounded-box bg-base-100 p-8 @3xl:p-10', {
              children: [
                ...
                el('p', 'text-lg leading-relaxed text-base-content', {
                  text: 'A plant kitchen that puts vegetables first. Seasonal, colourful, and genuinely delicious — not worthy. Open for lunch and dinner, Tuesday through Sunday.',
                }),
        ...
        children: [
          ...
          el('div', 'grid grid-cols-1 gap-6 @3xl:grid-cols-3', {
            children: [
              ...
              card('sprout-dish-1', 'Bowls & mains', 'Big, generous bowls off the grill and the fire — smoky aubergine, heritage grains, bright herb dressings.', 'A colourful roasted-vegetable bowl'),
