...
const PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        options: [
            { name: 'Color', displayType: 'swatch', values: [{ value: 'Cream' }, { value: 'Terracotta' }] },
        ],
        variants: [
            { sku: 'LCC-DRIP-CRM', priceCents: money(34), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Cream' } },
            { sku: 'LCC-DRIP-TER', priceCents: money(34), inventoryPolicy: 'continue', optionValues: { Color: 'Terracotta' } },
        ],
    ...
    },
    {
        ...
        variants: [
            { sku: 'LCC-MUG-CRM', priceCents: money(18), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Cream' } },
            { sku: 'LCC-MUG-TER', priceCents: money(18), inventoryPolicy: 'continue', optionValues: { Color: 'Terracotta' } },
        ],
