...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-template-bold-athletic.ts"
...
import { sectionHead } from '../../packages/silica-catalog/src/sections/_shell';
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-3xl flex-col gap-6', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'So we build the other way round. Every piece is ridden long and hard before it ships — over passes, through winters, deep into the kind of distance where cheap kit shows its true colours. If it does not hold up out there, it does not get made. That is the whole standard, and it is not negotiable.',
          }),
          el('p', 'text-lg leading-relaxed text-base-content', {
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Sizing question, a fault, or you just want to know how a piece holds up over a long winter? A real rider on the team reads every message and answers straight — no script, no runaround.',
          }),
          el('a', 'btn btn-primary btn-lg', {
            attrs: { href: 'mailto:hello@threshold.example' },
            text: 'Email the team',
          }),
        ],
      }),
...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    options: [
      { name: 'Colour', displayType: 'swatch', values: [{ value: 'Black' }, { value: 'White' }, { value: 'Hi-Vis' }] },
    ],
    variants: [
      { sku: 'THR-SCK-BLK', priceCents: money(22), isDefault: true, inventoryPolicy: 'continue', optionValues: { Colour: 'Black' } },
      { sku: 'THR-SCK-WHT', priceCents: money(22), inventoryPolicy: 'continue', optionValues: { Colour: 'White' } },
      { sku: 'THR-SCK-HIV', priceCents: money(22), inventoryPolicy: 'continue', optionValues: { Colour: 'Hi-Vis' } },
    ],
  ...
  },
  {
    ...
    variants: [
      { sku: 'THR-CAP-BLK', priceCents: money(28), isDefault: true, inventoryPolicy: 'continue', optionValues: { Colour: 'Black' } },
      { sku: 'THR-CAP-WHT', priceCents: money(28), inventoryPolicy: 'continue', optionValues: { Colour: 'White' } },
      { sku: 'THR-CAP-HIV', priceCents: money(28), inventoryPolicy: 'continue', optionValues: { Colour: 'Hi-Vis' } },
    ],
