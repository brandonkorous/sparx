    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'A question about a nib, a wholesale enquiry, or a custom gift order for the office? Tell us what you’re after and a real person at the shop will write back — usually the same day.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:hello@marginandco.example' }, text: 'Email the shop' }),
        ],
      }),
    ],
  }),
