...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-retail-stationery-editorial.ts"
...
// warm-red accent — the two colors a literary press already prints in. A characterful Fraunces
...
const SEARCH: Node[] = [
    pageMasthead('Search Margin & Co.', 'Looking for a ruling, a nib, an ink color or a gift? Search the whole shop and the journal below.'),
];
const CART: Node[] = [
...
const PRODUCTS: Product[] = [
    ...
    }),
    {
        ...
        variants: [
            { sku: 'MARGIN-PEN-FP-BLK', priceCents: money(68), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Ink Black' } },
            { sku: 'MARGIN-PEN-FP-BLU', priceCents: money(68), inventoryPolicy: 'continue', optionValues: { Color: 'Slate Blue' } },
            { sku: 'MARGIN-PEN-FP-OXB', priceCents: money(68), inventoryPolicy: 'continue', optionValues: { Color: 'Oxblood' } },
        ],
    ...
    },
    {
        ...
        variants: [
            { sku: 'MARGIN-INK-30-MID', priceCents: money(18), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Midnight' } },
            { sku: 'MARGIN-INK-30-SEP', priceCents: money(18), inventoryPolicy: 'continue', optionValues: { Color: 'Sepia' } },
            { sku: 'MARGIN-INK-30-TEA', priceCents: money(18), inventoryPolicy: 'continue', optionValues: { Color: 'Teal' } },
        ],
    ...
    },
    {
        ...
        variants: [
            { sku: 'MARGIN-WASHI-WRM', priceCents: money(12), isDefault: true, inventoryPolicy: 'continue', optionValues: { Color: 'Warm' } },
            { sku: 'MARGIN-WASHI-COL', priceCents: money(12), inventoryPolicy: 'continue', optionValues: { Color: 'Cool' } },
            { sku: 'MARGIN-WASHI-MON', priceCents: money(12), inventoryPolicy: 'continue', optionValues: { Color: 'Mono' } },
        ],
