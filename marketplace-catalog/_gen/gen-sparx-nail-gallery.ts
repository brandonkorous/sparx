...
//
// The Paintbox / Base Coat lane: a neutral gallery FRAME where the nail-art COLOR is the
...
//   pnpm --filter @wizeworks/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-sparx-nail-gallery.ts"
...
const SCHEDULING = {
    ...
    services: [
        ...
        },
        {
            handle: 'gel-manicure',
            name: 'Gel manicure',
            description: 'A long-wear gel color, cured to a high-gloss finish that lasts two weeks plus.',
            durationMinutes: 45,
            priceCents: 5000,
            bufferAfterMin: 5,
            assignmentStrategy: 'customer_choice',
        ...
        },
        {
            handle: 'gel-pedicure',
            name: 'Gel pedicure',
            description: 'The classic pedicure, finished in long-wear gel for a glossy color that stays put.',
            durationMinutes: 60,
            priceCents: 7000,
            bufferAfterMin: 5,
            assignmentStrategy: 'customer_choice',
...
const HOME = [
    ...
    serviceMenu({
        ...
        items: [
            ...
            { name: 'Gel manicure', priceCents: 5000, durationMin: 45, desc: 'Long-wear, high-gloss color that lasts two weeks plus.' },
    ...
    splitFeature({
        ...
        body: [
            'Lacquer is a small, daylight studio built around the work: a neutral room, two stations, and color that gets to be the loudest thing in it.',
