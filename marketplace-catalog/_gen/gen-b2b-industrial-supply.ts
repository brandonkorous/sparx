    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Tell us what your crew goes through and we will price your regular lines, set you up on net-30 terms, and put a name and a number to your account. Wholesale enquiries, standing orders and bulk quotes all start here.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:trade@ironworkssupply.example' }, text: 'Email the trade desk' }),
        ],
      }),
    ],
  }),
