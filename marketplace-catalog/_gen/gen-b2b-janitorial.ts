...
//   pnpm --filter @sparx/api-rest exec tsx "$PWD/marketplace-catalog/_gen/gen-b2b-janitorial.ts"
    ...
    children: [
      el('div', 'mx-auto flex w-full max-w-xl flex-col items-center gap-5', {
        children: [
          ...
          el('p', 'text-lg leading-relaxed text-base-content', {
            text: 'Tell us about your building — square footage, the closets you stock, and how often you want deliveries — and we’ll set up contract pricing, net-30 terms and a delivery schedule that fits. A real person at the warehouse will get back to you.',
          }),
          el('a', 'btn btn-primary btn-lg', { attrs: { href: 'mailto:accounts@saniworx.example' }, text: 'Request a trade account' }),
        ],
      }),
    ],
  }),
...
const PRODUCTS: Product[] = [
  ...
  singleCase({
    ...
    description:
      'Colour-coded 16-inch microfibre cloths that lift dust and grime with water alone — launderable up to 200 washes, so the cost per use undercuts disposable wipes fast. Pack of 50 cloths. Minimum order 1 pack.',
    price: 32,
    sku: 'SANI-MF-PK50',
    ...
    seoDescription: 'Colour-coded 16-inch microfibre cloths, launderable to 200 washes. Pack of 50 at trade pricing.',
  }),
  {
    handle: 'floor-pads',
