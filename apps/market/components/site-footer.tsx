...
import { SparkFooterPeek, Wordmark } from '@/components/sparx-brand';
...
export function SiteFooter() {
  return (
    ...
    // the footer's TOP edge and is hidden behind its opaque background until he
    // rises past the border, so the footer has to out-stack him (`relative
    // z-10`). Same gesture the workbench sign-in pane uses. Full contract in
    // <SparkFooterPeek>.
    <div className="relative">
      <SparkFooterPeek />

      <footer className="border-base-300 bg-base-100 relative z-10 border-t">
        <Container>
          <div className="grid grid-cols-1 gap-8 py-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_repeat(3,1fr)]">
            ...
            <div>
              ...
              <p className="mt-3 max-w-xs text-sm">
                One destination for thousands of independent sellers. Real shops, real makers,
                shipped direct.
              </p>
              <Button
