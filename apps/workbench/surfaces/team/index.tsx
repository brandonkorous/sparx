...
// plain count on the left, the same module-coloured button on the right.
//
...
/** Where a person is in their life on this team, as one word plus a colour.
 *
 *  State is its own colour axis — it is not the module hue and not decoration,
