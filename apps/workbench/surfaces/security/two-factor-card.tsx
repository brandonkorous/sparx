    ...
    <div className="border-base-300 flex flex-col gap-3 rounded border p-3">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button
          ...
          variant="outline"
          onClick={() => {
            const blob = new Blob([`sparx backup codes\n\n${asText}\n`], {
              type: 'text/plain',
            });
    ...
    >
      ...
      {step === 'verify' ? (
        <div className="flex flex-col gap-4">
          {errorAlert}
          <Text className="text-sm">
            Last step: enter the 6-digit code your app is showing for sparx right now. Nothing is
            switched on until this works, so a code that will not verify costs you nothing.
          </Text>
