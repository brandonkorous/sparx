    ...
    return (
        <Field>
            ...
            <div className="flex items-center gap-3">
                <div
                    className={`rounded-box relative flex size-20 shrink-0 items-center justify-center overflow-hidden border ${dark ? 'bg-neutral border-neutral' : 'bg-base-200 border-base-300'
                        }`}
                >
                    {value && asset?.url ? (
                        <Image
