...
import { CLAUSE, TENSE, AUDIENCE, connector as conn, industryOf } from '@sparx/story-schemas';
import {
  flatUnused,
  type StoryDispatch,
  type StoryState,
...
// Every coloured word is a chip you tap to change; ghost slots invite the next
