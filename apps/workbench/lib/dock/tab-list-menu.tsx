...
//
// Colour is the module's, exactly as on the strip: the icon carries the hue on
...
function TabListRow({ panel, active, onActivate, onClosed, onNavigate }: TabListRowProps) {
  ...
  return (
    ...
    <li data-module={definition?.module ?? 'platform'} className="flex items-center gap-0.5">
      {/* The tab you are on is the module hue itself — colour carries "you are
      ...
      >
        ...
        {/* Same signal, same colour, same wording as the tab's — the list is
