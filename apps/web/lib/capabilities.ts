...
export const CAPABILITY_AREAS: CapabilityArea[] = [
  ...
  },
  {
    ...
    summary: 'Accounts, net terms, RFQ, purchase orders, fleet, scheduling.',
    accent: '#475569',
    module: true,
    capabilities: [
      ...
      live('Service scheduling & appointments'),
  ...
  },
  {
    ...
    capabilities: [
      ...
      building('Authored billing documents'),
      building('Cost-derived line markup'),
      building('Immutable stage snapshots'),
      building('Document tax & surcharges'),
      building('Payments & AR aging'),
      planned('Standalone invoices'),
  ...
  },
  {
    id: 'chat',
    name: 'Live Chat',
    summary: 'AI-first storefront chat with a real-time staff inbox.',
    accent: '#F43F5E',
    module: true,
    capabilities: [
      live('Storefront chat widget'),
  ...
  },
  {
    ...
    capabilities: [
      ...
      planned('Storefront attribution'),
