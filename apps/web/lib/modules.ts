...
export const MODULES: Record<MarketingModule, ModuleMeta> = {
  ...
  commerce: {
    ...
    features: [
      {
        number: '01',
        title: 'Inventory that actually tracks.',
        body: 'Variants, bundles, kits, reservations, low-stock alerts. Real-time across every channel — storefront, MCP, manual orders.',
      },
      {
        number: '02',
        title: 'Checkout that converts.',
        body: 'Single-page, address autocomplete, saved payment methods, Apple Pay & Shop Pay parity. Conversion-optimized out of the box.',
      },
      {
        number: '03',
      ...
      },
      {
        number: '04',
        title: 'Tax & shipping.',
        body: 'Avalara and TaxJar for tax; Shippo and EasyPost for shipping rates and labels. Plug your account, done.',
      },
      {
        number: '05',
        title: 'Discounts & gift cards.',
        body: 'Per-product, per-customer, per-cart rules. Stackable or exclusive. Gift cards with reloadable balances.',
      },
      {
        number: '06',
        title: 'Order ops at scale.',
        body: 'Bulk fulfillment, batched picking, returns/refunds without a portal walkthrough. Built for actual shipping volume.',
      },
    ],
    pricing: {
      price: '$49',
  ...
  ai: {
    ...
    features: [
      ...
      },
      {
        ...
        body: 'Tools are typed and self-describing. The model figures out the schema. You just ask.',
      },
      {
        number: '06',
        title: 'Streaming responses.',
        body: 'Tool results stream back, the model reasons over them in real time. No "thinking" stalls for multi-step queries.',
      },
    ],
    pricing: {
      price: '$49',
