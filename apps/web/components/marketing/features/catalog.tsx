 ...
 * because these are fill colours and were never legible as ink. A filled header
 * measures 4.6:1 to 8:1 across all twelve — so the loudest hue moment on the page
 * is also its most readable element, and the modules read as a colour-coded
  ...
  return (
    ...
    >
      {/* The module's hue lives HERE — a filled header, not a tinted card and
          not coloured text. Both of those were measured and both failed: a
          ...
          on white, because these hues are fill colours that were never legible
