...
// ── ASK IN PLAIN ENGLISH · example exchanges ────────────────────────────────
function AskInPlainEnglish() {
  const exchanges: { ask: string; call: string; answer: string; write?: boolean }[] = [
    {
      ask: 'What are my top 10 customers by revenue this quarter?',
      call: "get_top_customers({ period: 'this_quarter', limit: 10 })",
      answer:
        'Your top 10 this quarter: Acme Fleet Services — $47,200 (12 orders), Desert Trucking Co — $38,500 (8 orders), …',
    },
    {
      ask: 'Which customers haven’t ordered in 90 days? Send them a win-back email.',
      call: "get_inactive_customers({ days: 90 }) → send_broadcast({ template: 'win-back' })",
      answer:
        'I found 47 customers inactive for 90+ days. I’ll use your “Win-Back” template — confirm to send?',
      write: true,
    },
    {
      ask: 'What’s my revenue this month vs last month?',
      call: "get_revenue_summary({ period: 'this_month', compare_to: 'last_month' })",
      answer:
        'This month: $84,200 (↑ 23% vs $68,400 last month). Best product: Bosch Injector Set, $12,400.',
    },
  ];
  ...
  return (
    <Section surface="surface" padding="lg">
      <SectionHeader
        ...
        lede={
          <>
            You don&rsquo;t write queries or learn a schema. You ask the way you&rsquo;d ask a
            colleague; your AI picks the right tools and reasons over the live results.
          </>
        }
      />
            ...
            >
              <span
                style={{
                  ...
                  textTransform: 'uppercase',
                  color: e.write ? MODS.commerce.text : AI.text,
                }}
              >
                {e.write ? 'MCP · write · confirms' : 'MCP · read'}
              </span>
              <code
                style={{
                  fontFamily: MONO,
