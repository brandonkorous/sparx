...
export function CrmHero() {
    ...
    return (
        ...
        // faintest possible version of the color the rest of the page needs to
        // mean something — and /crm leans on that color 53 times.
        //
        ...
        <section data-theme="dark" className="bg-base-100 px-page rounded-b-4xl pt-20 pb-28">
            <Container>
                ...
                full contrast on the dark island with no color decision here. */}
        ...
        <div className="bg-base-100 border-base-300 overflow-hidden rounded-2xl border">
            ...
            <div className="px-5 pt-1.5 pb-3.5">
                ...
                {crm.signals.map((s, i) => (
                    <div
                        key={s.label}
                        className={`flex items-center gap-[11px] py-2.5 text-sm ${i === 0 ? '' : 'border-base-200 border-t'
                            }`}
                    >
                ...
                all five stay legible with no per-tag color decision. The
