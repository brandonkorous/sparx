...
const BARCODE_BARS = Array.from({ length: 56 }, (_, i) => BARCODE_WIDTHS[i % BARCODE_WIDTHS.length]);
                    ...
                    <Card className="bg-secondary text-secondary-content relative overflow-hidden sm:min-h-[520px] lg:row-span-2 lg:min-h-[700px]">
                        <CardBody>
                            <div className="flex max-w-md flex-col gap-4">
                                ...
                                <Text className="text-secondary-content/85 text-2xl max-w-xl">
                        ...
                        <div
                            className="border-base-300 bg-base-100 text-base-content mx-6 mt-2 mb-6 border-t border-x px-6 pt-6 pb-10 font-mono text-sm shadow-2xl sm:absolute sm:right-6 sm:bottom-0 sm:mx-0 sm:mt-0 sm:mb-0 sm:w-[60%] sm:translate-y-30 sm:rotate-[-4deg]"
