                ...
                {steps.map((s, i) => {
                    ...
                    return (
                        <div key={s} className="flex items-center gap-3">
                            <span
                                className={`flex h-[18px] w-[18px] shrink-0 items-center justify-center rounded-full ${done ? M.bg : 'bg-base-200 border-base-300 border'
                                    }`}
                            >
                            ...
                            <Text
                                as="span"
                                className={`text-sm ${done ? '' : ''} ${i === activeIdx ? 'font-medium' : 'font-normal'
                                    }`}
                            >
                                {s}
                            </Text>
