                ...
                dynamic case — there is no utility class for 37.3%. */}
                        ...
                        <div className="flex flex-col">
                            {MARCH.map((slice, index) => (
                                <div
                                    key={slice.label}
                                    className={`flex items-baseline justify-between gap-4 py-2.5 ${index === MARCH.length - 1 ? 'border-base-300 mt-1 border-t pt-4' : ''
                                        }`}
                                >
            ...
            <Card className="mt-14">
                <CardBody className="gap-0">
                    ...
                    {JOBS.map((job) => (
                      ...
                      state is its own color axis — never the module hue. */}
                                    <Badge
