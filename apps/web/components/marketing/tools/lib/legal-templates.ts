...
export function buildPrivacyPolicy(d: LegalData): string {
  ...
  if (d.collectsAccount)
    collected.push('- **Account information** you provide, such as your name and email address.');
  if (d.collectsPayment)
    collected.push(
  ...
  if (collected.length === 0)
    collected.push('- Information you choose to provide when you contact us.');

  const rights: string[] = [];
  if (d.gdpr)
    rights.push(
      '### Your rights (GDPR)\n\nIf you are in the European Economic Area or the UK, you have the right to access, correct, delete, or restrict the processing of your personal data, and to data portability. You may also object to processing and lodge a complaint with a supervisory authority. To exercise these rights, contact us at ' +
        mail(d) +
        '.'
    );
  if (d.ccpa)
    rights.push(
      '### Your rights (CCPA)\n\nIf you are a California resident, you have the right to know what personal information we collect, to request its deletion, and to opt out of any sale of personal information. We do not sell your personal information. To exercise these rights, contact us at ' +
        mail(d) +
        '.'
    );
  ...
  return [
    ...
    ...(d.sharesThirdParties
      ...
      : [
          `## Sharing`,
          ``,
          `We do not sell your personal information. We only share it where necessary to operate our services or comply with the law.`,
          ``,
        ]),
    `## Data security`,
    ``,
  ...
  return [
    ...
    ...(d.collectsAccount
      ? [
          `## Accounts`,
          ``,
          `When you create an account, you must provide accurate information and keep your credentials secure. You are responsible for all activity under your account.`,
          ``,
        ]
      : []),
