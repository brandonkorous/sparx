...
/* ------------------------------------------------------------------ *
 * HSL + colour-wheel harmonies
 *
 * The palette generator builds matching accent colours by rotating the
...
/** A named colour in a generated palette (one primary + up to four accents). */
...
/**
 * Generate `count` (1–4) accent colours that harmonise with `baseHex` using a
 * classic colour-wheel scheme. Hue schemes rotate the base hue by fixed
 * offsets; monochromatic keeps the hue and steps the lightness. The base colour
