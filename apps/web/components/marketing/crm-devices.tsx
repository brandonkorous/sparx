...
// measures 1.79:1 on white — it is a FILL colour, not an ink, and as 14px text it
...
// its `fill` prop applies a utility. A component whose prop is a colour string
...
// section on the page that fills with the module colour — everywhere else cyan
