// The pricing facts — the single source for every pricing surface, kept apart
// from the sections that render them so a redesign changes the visual layer and
// never the numbers. That separation is the whole reason this file exists: the
// page was once a single 918-line `pricing-page.tsx` with data and rendering
// fused together, and pulling the facts out here is what let the surface be
// rebuilt without re-typing a single figure. Editorial data-as-code:
