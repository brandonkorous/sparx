 ...
 * that a visitor who signs up meets the SAME three colours on the real screen
 ...
 * anyone parses a minus sign. Colour carries the sign; the sign is the backup.
 */
...
/**
 * One line of a money breakdown: a label, an optional colour swatch naming which
...
export function MoneyRow({
  ...
  label: ReactNode;
  value: string;
  /** Renders the kind's colour swatch and tints the figure. */
  kind?: CostKind;
 ...
 * this job make money — which is its own colour axis and never module identity.
 */
 ...
 *
 * It exists because the colours do real work on this page — every subsequent
 ...
 * every later section drop the words and keep the colour.
 */
