 ...
 * resolves to the dark theme's near-black canvas (`#1a1a1a`) through a token
 * rather than a hardcoded hex, so every button/text color below resolves
 * automatically with zero hardcoded hex.
 */
