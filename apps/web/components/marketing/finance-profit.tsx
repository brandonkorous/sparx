...
// also happens to be where the colour argument lands hardest: a red February
...
//
// docs/148 §5, binding: "the profit surfaces are a colour problem before they
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card>
            <CardBody className="gap-4">
              ...
              <DailyBars />
              <Text>
                Each bar is coloured by its own sign rather than hanging below a line somebody has
                to find first. Four days in March cost more than they brought in — the 3rd, the 7th,
...
// `revenueBasis` in packages/finance/src/jobs.ts, and the standing rule that a
