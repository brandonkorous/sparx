...
// everything in ModuleProvider module="builder" so the WizardFrame rail and the
// step accents pick up Builder Indigo (the site-building module color), matching
// where the tenant lands afterwards.
//
// No chrome here: the WizardFrame's page variant owns the whole viewport and its
