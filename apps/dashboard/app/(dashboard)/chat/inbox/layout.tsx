...
export default async function ChatInboxLayout({
  ...
  return (
    <ChatSocketProvider>
      <div className="bg-base-100 grid h-[calc(100dvh-4rem)] grid-cols-1 md:grid-cols-[320px_1fr]">
        <aside className="border-base-300 bg-base-200 overflow-hidden border-r">
