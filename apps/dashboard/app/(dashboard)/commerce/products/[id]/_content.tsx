  ...
  return (
    <>
      ...
      <ModuleProvider module="commerce" className="@container flex h-full min-h-0">
        <div className="bg-base-200 flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto">
          <div className="p-6">
            ...
            <div className="mt-6 @[820px]:hidden">
              <div className="border-base-300 bg-module bg-soft rounded-lg border p-5">
        ...
        <aside className="border-base-300 bg-module bg-soft hidden w-[300px] shrink-0 overflow-y-auto border-l px-6 py-6 @[820px]:block">
          <ProductSummaryRail {...railProps} />
        </aside>
      </ModuleProvider>
    </>
