...
// dynamic route — the intended behavior — so it's what `fullPage` / `newTab`
// detail-view preferences, deep links, and the overlay's "maximize" button
// resolve to; no page-level Container/PageHeader, so the title isn't rendered twice.

export const dynamic = 'force-dynamic';

export default function NewTaxonomyPage() {
  return <TaxonomyCreateForm surface="page" />;
}
