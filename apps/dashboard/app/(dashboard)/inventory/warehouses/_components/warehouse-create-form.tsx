...
export function WarehouseCreateForm({ surface }: WarehouseCreateFormProps) {
  ...
  return (
    <Stack gap={6}>
      {surface === 'overlay' && (
        <Stack gap={1}>
          <Heading level={2}>New warehouse</Heading>
            ...
            <Stack gap={4}>
              ...
              <Stack gap={1}>
                ...
                <Text size="xs" variant="muted">
                  `dropship` warehouses are populated by supplier feeds; `virtual` is a placeholder
        ...
        <Card className="mt-6">
          <CardHeader>
            <Stack gap={1}>
              ...
              <CardDescription>
                When a cart on the named channel has no explicit warehouse, the picker uses this as
                a fallback. Optional — leave empty if you want every channel routed the same way.
              </CardDescription>
            </Stack>
          </CardHeader>
          <CardContent>
