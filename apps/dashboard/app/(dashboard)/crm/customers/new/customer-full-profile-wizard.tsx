...
const CONTACT_FIELDS = [
  ...
  { key: 'email', label: 'Email', type: 'email' as const, required: true, placeholder: 'jane@example.com' },
...
const ADDRESS_FIELDS = [
  ...
  { key: 'line1', label: 'Address line 1', type: 'text' as const, required: true, placeholder: '123 Main St' },
