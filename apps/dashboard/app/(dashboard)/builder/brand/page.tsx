...
// Brand & Theme, hosted in the Builder module. Authors the ACTIVE site's identity
// (docs/49 "full per-site brand"): the customer-facing NAME (Property.name), its
// own social links, and its brand — the tenant BASE brand for the primary site,
// or this site's OVERRIDE for a non-primary one. Switching sites (breadcrumb)
// swaps everything the page shows.
//
