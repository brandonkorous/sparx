...
export default function AccountOverviewPage() {
  ...
  return (
    <div>
      ...
      <p className="st-muted" style={{ marginBottom: '1.75rem' }}>
      ...
      >
        <Link href="/products" className="st-card" style={{ padding: '1.25rem', display: 'block' }}>
          ...
          <p className="st-muted" style={{ marginTop: '0.35rem' }}>
            Browse the full catalog.
          </p>
        </Link>
        <Link href="/cart" className="st-card" style={{ padding: '1.25rem', display: 'block' }}>
