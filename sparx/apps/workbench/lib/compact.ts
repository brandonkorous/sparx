...
/** Written by the workbench on every load, read back by the server on the next. */
export const COMPACT_COOKIE = 'sparx_compact';
...
interface CompactHint {
  /** `sparx_compact`, if this browser has been here before. */
