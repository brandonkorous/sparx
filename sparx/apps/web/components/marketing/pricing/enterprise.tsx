...
/**
 * "Bigger needs? Let's talk." — the enterprise beat, on a DOM-scoped
 * `data-theme="dark"` island. The island declares the tier and paints nothing
 * itself, so both Buttons and every text/check color resolve from
 * `color`/`variant` props and `base-content`/`primary` tokens — zero hardcoded
 * hex.
 */
