...
/**
 * The "switch on what you need" beat. The tile and summary card are pure
 * silicaui and shared byte-for-byte with /pricing's switchboard; the outer
 * shell here is `bg-accent` (a real theme token) with `size="display"` plus a
 * `text-*` class carrying the headline scale.
 */
...
export function LandingSwitchboard() {
