...
/**
 * The hero. Pure silicaui — no `primitives.tsx` (Display/Container/
 ...
 * global — see sparx/packages/brand/src/theme.css), so every color below is a plain
