 ...
 * @wizeworks/dropship package and dashboard surfaces. The selectable vendors are
...
// straight and grounded in docs/14 (PRD) + docs/17 (billing) + @wizeworks/dropship —
