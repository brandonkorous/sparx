 ...
 * shown is real: wizeworks/services/api-mcp serves Streamable HTTP at mcp.sparx.works/v1,
...
/** The real MCP transport endpoint — wizeworks/services/api-mcp, behind Caddy. */
