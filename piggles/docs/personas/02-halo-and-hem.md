...
- [157](issues/157-a-salons-social-card-and-error-page-were-painted-in-another-companys-colour.md) — **major, fixed.** Found while taking [128]'s hex inventory: the accent rule across the top of her link-preview card, and the one button on her site's error page, were both a hardcoded sparx Ember.
...
[157]: issues/157-a-salons-social-card-and-error-page-were-painted-in-another-companys-colour.md
...
| [157](issues/157-a-salons-social-card-and-error-page-were-painted-in-another-companys-colour.md)          | major    | Her link-preview card and error page wore another company's colour                   | yes   | Accent now per brand from brand-core; no e04631 left under apps/             |
