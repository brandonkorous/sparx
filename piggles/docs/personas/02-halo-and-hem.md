...
Machine clock is **PDT (UTC-7)**. **All seven standing checks are done** and recorded
below: reload · deep link · restore, someone else's business, money at the edges,
wrong moves, dates, the buyer's side, and now **one job without a mouse**.
...
Still open from act 6: the consultation rule before color is words on a page and
...
- [111](issues/111-the-appointment-does-not-know-who-it-is-for-so-an-allergy-sits-four-screens-away.md) — **fixed.** Priyanka's ammonia allergy was four screens from her color appointment, and the client's name on the booking was not even a link. The appointment now carries who it is for, how to reach them, and what is written down about them.
...
- [128](issues/128-the-check-that-was-supposed-to-catch-the-brand-leak-does-not-look-for-it.md) — **major, fixed.** `check:boundaries` is documented as failing on a brand literal under `wizeworks/**`. It had no string rule at all, and ran green on [122] for as long as [122] existed. The rule now exists, was proved red on [122] itself, and its first run found **81 more sentences** naming a product in shared platform code — every one of them now resolved or reworded.
- [157](issues/157-a-salons-social-card-and-error-page-were-painted-in-another-companys-color.md) — **major, fixed.** Found while taking [128]'s hex inventory: the accent rule across the top of her link-preview card, and the one button on her site's error page, were both a hardcoded sparx Ember.
...
token was doing two jobs — the chrome's fill AND the semantic grey — and a color
...
because one color token carried an alpha byte: `--color-group-people: #8fc2c06e`
...
**One job without a mouse is done** — a whole booking taken with the keyboard,
which came back clean apart from one red error that only appears if you TYPE the
date ([158]), plus a note about how long the keyboard path is ([159]). **The buyer's
side is done** — five defects out of it ([152]–[156]), and the first two were the
whole point of the check: a client could not reach her own appointment at all.
**Dates is done** — four defects out of it ([148]–[151]), and the last
...
| Color consultation   | `3fa80723-0fee-477d-8002-35536c5bb35d` | Nia only (`color`)           |
...
| Full head highlights | `7b8f00de-a8c2-4e6e-9abd-41de4b41d918` | Nia only (`color`)           |
| Restyle, long hair   | `cf8a28bf-d897-4f7f-ad4a-ac24fd8b81e6` | either · **customer choice** |
| Root tint            | `3049177d-9fa6-4b7b-93d9-ea7644bfd46f` | Nia only (`color`)           |
| Toner and gloss      | `e7ad4f40-f36a-4834-9324-6e6c2ae5e53a` | Nia only (`color`)           |

People: Nia `94409651-7acb-45a9-ae90-16b1198c48c3` (`cut,color,styling,treatment`),
...
told on email and text. Her Thursday 20 Aug color is the past booking created
...
| -------------------- | ------- | ------- | ------------------------------ |
| Color consultation   | 20 min  | free    | must precede any color booking |
...
| Gallery             | Real work — the reason anyone books a colorist                        |
...
services that need one, the consultation rule visible before a color booking,
...
| 2026-08-23 | 9   | **What reaches them.** The booking pane never said what a customer had been told or would be told, though the ledger has carried it since act 7. It does now ([127](issues/127-a-booking-never-says-whether-anyone-is-being-reminded.md)) — Priyanka's Friday color lists three reminders **To go** with their dates; Margot's Friday cut lists a confirmation and a change notice **Sent** and then says no reminder is due, and why. That sentence is the residue of [126]: attaching a rule set now does not catch up a booking already taken.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 2026-08-22 | 10  | **The phone, and the two things it made impossible to ignore.** Opened the console in a 390px frame on dark. Her Save button was see-through: one color token in the People group carried an alpha byte (`#8fc2c06e`), so every control in Customers, Messages and Bookings drew at 43% ([130](issues/130-every-button-in-three-apps-is-see-through-in-the-dark.md)). Asked what color the text on a calendar event was and got `#27232a` on `#272b37` — **1.09:1** — which is not faint, it is blank: `neutral` was Piggles' chrome color, pinned dark in both themes, and silica's soft/outline/ghost variants ink themselves with the color itself. 416 controls draw that way ([131](issues/131-the-console-s-grey-is-invisible-on-the-dark-canvas.md)). Both fixed at the token, plus a guard proved red on the real defect.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| 2026-08-22 | 10  | **The list, the footer and the folded toolbar.** The bookings list spent five lines on a date and clipped its badges ([140](issues/140-the-bookings-list-on-a-phone-spends-five-lines-on-a-date.md)). Every list's footer told a phone about shift-click and alt-click — 87 hand-written copies of one sentence, in five wordings, none of them changeable at once ([138](issues/138-eighty-seven-lists-each-wrote-their-own-instructions-for-a-keyboard.md)). The narrow toolbar's menu held an unlabelled chain glyph, a right-shoved toggle and the wrong app's color ([141](issues/141-a-narrow-toolbar-s-menu-loses-the-app-it-belongs-to.md)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| 2026-08-23 | SC  | **The buyer's side, one: she booked, and there was no way back.** Imani Reyes booked a blow dry through the real form. The confirmation gave her the time, the address and three calendar links, and nothing to change it with. The email's **Manage booking** button went to `/account/bookings` — a sign-in wall she has no account for, headed _Welcome back_ (she has never been here) and offering to _track orders and check out faster_ (the salon sells nothing at all) ([153](issues/153-there-is-no-way-back-to-her-appointment-without-making-an-account.md), fixed).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2026-08-23 | SC  | **The buyer's side, two: making an account split her in half.** She created one with the exact address she had booked with, landed on _My bookings_ — and read **You have no upcoming bookings**. So she booked again, signed in, with her own email in the form. Same. Nia's customer list now held **two Imani Reyes**, adjacent, identical, one with the appointments and one with the login ([152](issues/152-the-salon-has-two-of-her-and-the-appointment-is-on-the-one-she-cannot-see.md), fixed). Ten of this salon's eleven customers had no site written on them, so every one of them was one sign-up away from the same split.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 2026-08-23 | SC  | **The buyer's side, three: she moved it and cancelled it, from a link.** Delphine Aubert booked Wed 26 Aug at 2:00 PM, opened **Change or cancel this appointment** on the confirmation, moved it to Thu 27 at 11:00 AM and then called it off — no account, no password, no phone call. Nia's diary followed both times. The way back is a signed per-booking link now, the same HMAC the `.ics` download has always used, with its own scope so a calendar file can read and never cancel.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2026-08-23 | SC  | **The buyer's side, four: the only button on her empty bookings page was blank.** A solid brown square, no word in it, on a page that had just told her she has nothing ([154](issues/154-the-only-thing-to-click-on-her-empty-bookings-page-is-a-blank-square.md), fixed). One call site put the label inside silica's `render` element instead of the Button's children; the other fifteen across the site do it correctly.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 2026-08-23 | SC  | **From the same run, on Nia's side: every blow dry in her diary named nobody.** Forty minutes is three rows tall and issue 148's fix drew time and service into them, dropping the client — the one fact on a block that is nowhere else on the screen. Three of her ten services are affected ([155](issues/155-every-blow-dry-in-her-diary-named-nobody.md), fixed). The clock now shares the first row and the client gets the second.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 2026-08-23 | SC  | **And, checking what her confirmation email says: another product's name in her account.** Her email list carried **Welcome (sparx — Salon (Editorial))** — a product she has never heard of, in a list she opens to write to her clients ([156](issues/156-another-products-name-was-sitting-in-her-list-of-emails.md), fixed). 169 of the catalog's 191 bundles were STALE against their own generators: the name was cleaned at the source and the bundles were never regenerated, so the corrected name never reached the file the installer reads.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 2026-08-23 | SC  | **Standing check, without a mouse: one booking, keyboard only.** Booked Cut and finish with Nia for Tue 25 Aug 10:45 AM without touching the pointer once — Tab to the service card, Enter, Tab through the three stylists, Enter on Nia, type the date, Tab to a time, Enter, four fields, Enter on **Book 10:45 AM**. It works, and most of it is genuinely well built: a visible focus ring on every control, focus landing in the CONTENT after choosing a service rather than back at the top of the menu, and the confirmation carrying so it is announced. One defect, and it is invisible to anyone with a mouse: TYPING the date fires a lookup per keystroke, so the year goes out as 2, 20, 202 and finally 2026 — two of those came back 422 and printed **"Request validation failed."** in red across her booking page, where it then outlived the correct answer and sat above the Book button while I filled the form ([158](issues/158-typing-the-date-put-a-red-error-across-her-booking-page.md), fixed: half-typed dates never leave the browser now, and a schema rejection is never read out to a customer). Also filed: no skip link and one tab stop per time chip ([159](issues/159-every-page-of-her-site-makes-a-keyboard-user-walk-the-whole-menu.md), minor, not fixed — it is seeded site chrome).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2026-08-23 | BL  | **Backlog, [128]: the guard that was documented and never written.** `wizeworks/CLAUDE.md` had listed a brand-literal rule among the four things `check:boundaries` fails on since the tree move; the script had three rules and no string rule at all. Wrote it — a brand standing as its own word inside a sentence of four words or more, so it fires on "sparx cannot read balances from Xero yet" and not on `sparx.works` or `/sparx/tenants` — and proved it RED by restoring [122]'s own "Sent with sparx" line. Its first honest run found **81 more**: the pulse survey question, three accounting errors, a feedback-reply notification title, "Brings orders into sparx" under every sales channel, and a testimonial about another company's software inside a catalog block a tenant stamps onto her own page. All 81 cleared. Three partner email templates came off the exemption list that had been holding them out of the sweep that fixed 110 others. Two real brand hexes turned up in the tenant site renderer on the way and are [157](issues/157-a-salons-social-card-and-error-page-were-painted-in-another-companys-color.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Full head highlights · the 13:00 lunch        | **nothing**                        | Her break, and only she does color                                       |
...
**Done 2026-08-23.** She could not. The confirmation offered three ways to add
the appointment to a calendar and none to change it; the email's **Manage
booking** button opened a sign-in wall headed _Welcome back_ and offering to
_track orders and check out faster_ at a salon that sells nothing; and making an
account with the same address produced a SECOND customer, so her own bookings
page said _You have no upcoming bookings_ while two appointments sat in Nia's
diary. She can now. Five defects ([152]–[156]).

The shape was the opposite of the wrong-moves check. There the records were right
and the sentences were wrong; here **the record itself was wrong** — the salon
had two of the same woman, adjacent rows, same name, same email, one holding her
appointments and one holding her login.

**Two clients and three bookings were left behind**, all made through the real
form and all kept by the run rule. **Imani Reyes** has a blow dry on Tue 25 Aug at
3:00 PM and another at 4:00 PM — the second is the one she made while signed in,
which is the defect [152] describes. She also has a duplicate customer row, which
is Nia's to merge and not a migration's. **Delphine Aubert** has one blow dry on
Thu 27 Aug at 3:15 PM, plus a cancelled one at 11:00 AM the same day: that is the
cancel step of this check doing real work.
...
| Buyer's side                 | **Done.** Booked as a guest, followed the confirmation, moved the appointment and called it off — no account, no phone call. Five defects ([152]–[156]); two were blockers and one of those was a wrong RECORD, not a wrong sentence: the salon had two of her.                                             |
| Someone else's business      | Done — deep-linked one of Marisol's orders; nothing came back                                                                                                                                                                                                                                               |
| One job without a mouse      | **Done.** A whole booking by keyboard: service → stylist → date → time → four fields → Book. Typing the date printed a raw schema error at the customer ([158], fixed); the path is long ([159])                                                                                                            |
| Time to live site            | —                                                                                                                                                                                                                                                                                                           |
...
[152]: issues/152-the-salon-has-two-of-her-and-the-appointment-is-on-the-one-she-cannot-see.md
[153]: issues/153-there-is-no-way-back-to-her-appointment-without-making-an-account.md
[154]: issues/154-the-only-thing-to-click-on-her-empty-bookings-page-is-a-blank-square.md
[155]: issues/155-every-blow-dry-in-her-diary-named-nobody.md
[156]: issues/156-another-products-name-was-sitting-in-her-list-of-emails.md
[157]: issues/157-a-salons-social-card-and-error-page-were-painted-in-another-companys-color.md
[158]: issues/158-typing-the-date-put-a-red-error-across-her-booking-page.md
[159]: issues/159-every-page-of-her-site-makes-a-keyboard-user-walk-the-whole-menu.md
...
| [127](issues/127-a-booking-never-says-whether-anyone-is-being-reminded.md)                                | major    | A booking never says whether anyone is being reminded                                | yes   | Priyanka’s color lists three reminders To go; Margot’s cut says none is      |
| [128](issues/128-the-check-that-was-supposed-to-catch-the-brand-leak-does-not-look-for-it.md)             | major    | The check that was meant to catch the brand leak does not look for it                | yes   | Proved red on [122]; 81 more sentences found and cleared                     |
...
| [130](issues/130-every-button-in-three-apps-is-see-through-in-the-dark.md)                                | blocker  | Every button in three of her apps is see-through in the dark                         | yes   | A color token carried an alpha byte; guard added, proved red                 |
...
| [152](issues/152-the-salon-has-two-of-her-and-the-appointment-is-on-the-one-she-cannot-see.md)            | blocker  | The salon has two of her, and the appointment is on the one she cannot see           | yes   | Booked as a guest, made an account, appointment was on it. One row, not two  |
| [153](issues/153-there-is-no-way-back-to-her-appointment-without-making-an-account.md)                    | blocker  | There is no way back to her appointment without making an account                    | yes   | Moved it and cancelled it from the confirmation link, with no account        |
| [154](issues/154-the-only-thing-to-click-on-her-empty-bookings-page-is-a-blank-square.md)                 | major    | The only thing to click on her empty bookings page is a blank square                 | yes   | Reads **Book an appointment** and opens the booking page                     |
| [155](issues/155-every-blow-dry-in-her-diary-named-nobody.md)                                             | major    | Every blow dry in her diary named nobody                                             | yes   | Her 40-minute blocks now read time + service, then the client                |
| [156](issues/156-another-products-name-was-sitting-in-her-list-of-emails.md)                              | blocker  | Another product's name was sitting in her list of emails                             | yes   | 169 bundles + 3 generators cleaned; every changed bundle version-bumped      |
| [157](issues/157-a-salons-social-card-and-error-page-were-painted-in-another-companys-color.md)           | major    | Her link-preview card and error page wore another company's color                    | yes   | Accent now per brand from brand-core; no e04631 left under apps/             |
| [158](issues/158-typing-the-date-put-a-red-error-across-her-booking-page.md)                              | major    | Typing the date put a red error across her booking page                              | yes   | Same keystrokes, no banner; 6 requests became 3, all 200                     |
| [159](issues/159-every-page-of-her-site-makes-a-keyboard-user-walk-the-whole-menu.md)                     | minor    | Every page makes a keyboard user walk the whole menu                                 | no    | Open — seeded site chrome, Brandon's call                                    |
