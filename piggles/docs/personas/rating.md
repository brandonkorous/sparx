...
**Scored so far: 22 of 323**, plus the P02 site row below, plus the status bar, which is console chrome rather
...
| P02 site — Halo & Hem          | 8      | 8    | Seven pages, three legal pages, a real 404, her own mark in the tab, and a price list that reads live from Bookings so it cannot go stale. No horizontal overflow on any page at 390px; the booking cards are whole-card taps at 16px. Light theme only — the site offers no dark. Held off 9 by the photographs being the starter pack's stock, and by the booking block's second `h1` ([095](issues/095-the-booking-list-put-a-second-page-title-on-her-homepage-in-words-she-cannot-change.md)). | P02     |
