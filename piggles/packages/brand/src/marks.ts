 ...
 *  the identity board without a second color token — which is what keeps it
...
// recoloring the letters to the brand pink would lose the mark's contrast, and
 ...
 *  spot of brand color in it. Always the brand pink, never `currentColor`. */
