...
//
// COLOUR RESOLVES FROM TOKENS, NEVER FROM THE SOURCE FILE. The delivered SVGs
...
export interface MarkProps {
  /** Sizing and colour come from utilities — `h-10 w-10 text-primary`. A numeric
 ...
 *
 *  The snout is drawn at 20% of the current ink rather than in a second colour,
 ...
 *  the only brand colour in the lockup. */
