...
// over the last 30 days", a confidence into a colour, a class letter into
...
/** How strongly a planning figure can be leaned on, as a colour. `assumed` is a
...
/** ABC is about where the money is, so A wears the strongest colour on screen. */
...
/**
 * How urgent a risk row is, coloured by when it bites rather than by size.
 *
 * Money at risk decides the ORDER of the list; this decides the colour of one
