                ...
                <div className="mx-auto flex w-full max-w-3xl flex-col gap-4">
                    <div className="flex flex-col gap-1">
                        ...
                        <Text>
                            {productCopy(
                                'inventory.gl.intro',
                                'What Piggles says your stock is worth, set against what your accounting system says, with every ordinary reason they differ named and priced.'
                            )}
                        </Text>
                    </div>
                                    ...
                                    <AlertContent>
                                        ...
                                        <AlertDescription>
                                            {productCopy(
                                                ...
                                                'Piggles does not keep your ledger, so it cannot know what your inventory account holds. Enter the balance below — off your trial balance, or from whoever keeps the books — and the difference gets worked out and explained. Until then there is nothing to compare against, which is why the figure is blank rather than zero.'
                                            )}
                                        </AlertDescription>
                                    </AlertContent>
                                </Alert>
                                    ...
                                    <AlertContent>
                                        ...
                                        <AlertDescription>
                                            {productCopy(
                                                ...
                                                'Once the timing differences below are allowed for, Piggles and your books agree exactly. This is the answer you want when the accountant asks.'
                                            )}
                                        </AlertDescription>
                                    </AlertContent>
                                </Alert>
                                            ...
                                            <tr key={`${line.kind}-${index}`}>
                                                    ...
                                                    <span className="flex min-w-0 flex-col gap-0.5">
                                                        <span className="truncate font-medium">
                                                            {line.kind === 'sparx_value'
                                                                ? productCopy('inventory.gl.ourFigure', 'What sparx says')
                                                ...
                                                <td className="text-right whitespace-nowrap">
                                                    {line.amountCents === null ? (
                                                        ...
                                                        <span
                                                            className={`font-medium tabular-nums ${line.kind === 'unexplained' && line.amountCents !== 0
                                                                    ? 'text-danger'
                                                                    : ''
                                                                }`}
                                                        >
