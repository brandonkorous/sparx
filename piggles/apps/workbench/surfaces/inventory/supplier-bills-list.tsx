...
import { Badge, Card, EmptyState, NativeSelect, Text, Timestamp } from '@wizeworks/silicaui-react';
  ...
  return (
    <div className={PANE_SHELL}>
      <PaneToolbar
        ...
        views={{
          target: '/inventory/supplier-bills',
          params: { state: view },
          onApply: (next) => {
            setView(next.state && next.state in VIEWS ? (next.state as View) : 'all');
          },
        }}
        refresh={
          <RefreshButton
