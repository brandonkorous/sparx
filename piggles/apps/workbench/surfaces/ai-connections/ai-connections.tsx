  ...
  return (
    <FormSection
      ...
      description={productCopy(
        ...
        'Piggles uses this account to write and answer for you — it is the AI service you already pay for. Piggles never uses AI on your behalf without it, and the work is billed to your provider, never to us.'
      )}
    >
      {credential && state ? (
        <>
              ...
              <AlertContent>
                ...
                <AlertDescription>
                  {productCopy(
                    ...
                    'Your account is connected, but nothing will use it until you add the Connections app — it is in All apps, at the foot of the rail.'
                  )}
                </AlertDescription>
              </AlertContent>
            </Alert>
              ...
              <AlertContent>
                ...
                <AlertDescription>
                  {productCopy(
                    ...
                    'You can connect your account now, but nothing will use it until you add the Connections app — it is in All apps, at the foot of the rail.'
                  )}
                </AlertDescription>
              </AlertContent>
            </Alert>
      ...
      {!canManage ? (
        ...
        <div className="border-base-300 rounded-lg border border-dashed p-4">
          <Text className="text-sm">
            {productCopy(
              'ai.mcp.empty',
              'No AI apps are connected yet. Add Piggles as a connector inside your AI app using the address above and approve access — it will appear here once you do.'
            )}
          </Text>
        </div>
      ) : (
