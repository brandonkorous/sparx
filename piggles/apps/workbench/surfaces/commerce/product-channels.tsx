        ...
        <div className="mx-auto flex w-full max-w-3xl flex-col gap-4">
          ...
          {listings.isError ? (
            ...
            <>
              ...
              {/* Absent entirely under a brand that has no marketplace — not
                  disabled, not renamed. See ProductAdapter.hiddenFeatures. */}
              {productHidesFeature('commerce.channels.market') ? null : (
