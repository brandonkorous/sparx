    ...
    <div className={PANE_SHELL}>
      <PaneToolbar label="Mailbox connection actions">
        ...
        <Text as="span" className="text-sm">
          {productCopy('crm.mailbox.testSignIn', 'sparx signs in once now to make sure it works.')}
        </Text>
      </PaneToolbar>
        ...
        <Card className="p-4">
          ...
          <Text className="mt-1">
            {productCopy(
              ...
              'Piggles will read new email from this account and show it on the matching customer’s record, and send your replies from this address.'
            )}
          </Text>
