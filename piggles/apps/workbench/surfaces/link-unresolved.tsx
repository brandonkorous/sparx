...
export function LinkUnresolvedSurface({ ctx }: { ctx: SurfaceContext }) {
  ...
  return (
    ...
    //
    // The EmptyState stays RAW here, deliberately. Four reasons share this pane
    // and two of them are `info` rather than `warning` — a permissions fact is not
    // a fault — and none of the house wrappers can carry that distinction:
