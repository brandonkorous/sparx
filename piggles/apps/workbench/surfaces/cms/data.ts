...
// in @sparx/cms). We keep those names verbatim rather than re-mapping, so there
 ...
 *
 * A local mirror of the `FieldDef` union that @sparx/cms-schemas validates on
 ...
 * that carries the state's colour on a `<Badge>`.
 */
