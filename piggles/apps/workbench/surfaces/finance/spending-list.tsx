  ...
  return (
    <div className={PANE_SHELL}>
      <PaneToolbar
        ...
        // Values, not markup: three open-ended sets that want a select, one short
        // fixed set that wants chips. The bar then owns their shape on the bar AND
        // in the narrow popover, and composes the saved-view snapshot from them.
        filters={[
          {
            label: 'When',
            key: 'period',
