...
// live `--color-*` tokens; series colours it cannot guess, so they are resolved
// off the DOM and handed over as concrete values.
//
// THE COLOUR IS THE POINT, not decoration. Profit is drawn as a bar PER DAY whose
// colour is decided by its own sign: a day that lost money is red, and it reads
// as a loss before anyone parses a minus sign or finds the zero line. A single
// series colour with negative bars hanging below the axis is technically the same
      ...
      series: [
        {
          ...
          data: points.map((point) => ({
            ...
            // Per-point, so the sign carries the colour. This is the whole
