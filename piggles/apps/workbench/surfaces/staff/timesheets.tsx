    ...
    return (
      <div className={PANE_SHELL}>
        <Card className="min-h-0 flex-1 items-center justify-center">
          <PaneLoadError
            title="Only an account admin can open timesheets"
            description="This grid shows what each person’s hours cost, which is their pay rate with one division undone. Hours on their own — without the money — are on each person’s record and on the schedule."
          />
        </Card>
      </div>
    );
          ...
          <div className="mx-auto flex w-full max-w-4xl flex-col gap-4">
            ...
            <Card className="flex flex-col gap-2 p-4">
              ...
              <Text className="text-sm">
                {productCopy(
                  'staff.payrollExport',
                  'Piggles does not run payroll and is not going to. What it can do is hand whoever does a file of this period’s approved hours per person, with their id in your payroll system so nobody has to match names in a spreadsheet.'
                )}
              </Text>
              <Button
                size="sm"
