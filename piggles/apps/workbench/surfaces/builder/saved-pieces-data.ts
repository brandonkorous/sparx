...
// wire in camelCase — see `toSummary`/`toDto` in @sparx/builder's
...
// carry the SHAPE only — no @sparx/builder-schemas dependency in the workbench.
// ══════════════════════════════════════════════════════════════════════════
...
/* ── Shapes (mirrors of @sparx/builder-schemas DTOs, carried not imported) ── */
...
/**
 * What a piece's REACH means, in an owner's words with the tone that colours its
