...
function DayChip({
    ...
    return (
        <button
            ...
            className={`hover:bg-base-300 bg-base-200 flex w-full min-w-0 items-center gap-1.5 rounded-md px-1 py-1 text-left ${movable ? 'cursor-grab' : 'cursor-pointer'
...
function EmptySlotChip({
    ...
    return (
        <button
            ...
            aria-label={label}
            onClick={onFill}
            className={`border-module/50 text-module flex w-full min-w-0 items-center gap-1.5 rounded-md border border-dashed px-1 py-1 text-left ${canWrite ? 'hover:bg-module hover:bg-soft cursor-pointer' : 'cursor-default'
                }`}
        >
...
function DayCell({
    ...
    return (
        <div
            ref={setNodeRef}
            className={`group/day relative flex min-h-28 flex-col gap-1 border-r border-b p-1.5 ${isOver
    ...
    return (
        ...
        <div className="border-base-300 flex flex-1 flex-col overflow-hidden rounded-xl border">
          ...
          the week view's taller cell. */}
            <div
                className={`grid flex-1 grid-cols-7 ${tall
...
function DraftCard({
    ...
    return (
        <button
            ...
            className={`border-base-300 hover:bg-base-200 flex w-44 shrink-0 items-center gap-2 rounded-lg border p-2 text-left ${canWrite ? 'cursor-grab' : 'cursor-pointer'
                } ${isDragging ? 'opacity-40' : ''}`}
            {...attributes}
            {...listeners}
        >
