 ...
 * praise is a success. Colour by MEANING — never for decoration.
 */
...
/**
 * Status is its own colour axis, and this ladder reads as PROGRESS: arrived →
 ...
 * painting it in alarm colours would be gratuitously harsh to the person who
