                                    ...
                                    {rows.map(({ entry, index }) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                //
                                                // Here the color genuinely distinguishes A from B: one
                                                ...
                                                className={`flex w-full items-center gap-3 rounded-md px-3 py-2 text-left ${isActive ? 'bg-base-200' : 'hover:bg-base-200'
                                                    }`}
