...
// The platform mark — a social network's own logo, in its own colour, on a disc.
//
// COLOUR. This is the ONE sanctioned place in the workbench for hard-coded colour,
// cleared with Brandon on 2026-07-28. The rule it steps around (RULE #1: colour comes from
...
//
// The three brands whose colour IS black (X, TikTok, Threads) let their disc melt into a
...
/** Each platform's own colour, as the brand publishes it. Not tokens, and not eligible to
...
/** Inset of the 24-grid glyph inside the 24-grid disc. 0.56 leaves a ring of brand colour
