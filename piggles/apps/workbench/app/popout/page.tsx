...
// controller, the brand configuration and every provider by reference. No state
// has to be synchronised across the boundary, and a pane behaves identically
// whether it is docked or floating on a second monitor.
//
...
// browser rather than a desktop shell, and it is the right trade: the
