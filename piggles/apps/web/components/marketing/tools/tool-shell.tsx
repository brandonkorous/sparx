 ...
 * the one thing this product has that a generic tool site does not: six colour
 ...
 *
 * The opening is now DRENCHED in the tool's group colour — a full band of solid
 ...
 * the product; and it is the same colour the app wears in the rail on day one.
 *
 ...
 * into an invoice. It is now three short lines inside the coloured band, beside
...
export function ToolShell({ tool, children }: { tool: PigglesTool; children: React.ReactNode }) {
 ...
 and out of white. */}
        {/* Above the band, not in it. A breadcrumb is the way back, not part of
            the statement — inside the colour it competed with the heading it
 ...
 features. */}
            {/* A stroke glyph beside each line, not an icon in a rounded chip
                  ...
                  It inherits the band's ink, so it needs no colour of its own. */}
