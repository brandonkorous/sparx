...
export const TOOL_CONTENT: Record<string, ToolContent> = {
  favicon: {
    learn: [
      ...
      },
      {
        ...
        body: 'A tab wants a small square. A phone saving you to its home screen wants a much bigger one, with no transparency, because iOS puts it on a coloured tile. Android wants one with room around the edges so it can crop it into a circle without cutting your logo in half. A browser showing a shortcut on a new tab page wants something in between. They all want different files, which is why a proper favicon is a set of about six things and a small text file listing them — and why generating it by hand is nobody’s idea of an afternoon.',
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'For the tab icon, yes — transparency is fine and usually better. For the Apple touch icon it is not: iOS renders transparent pixels as black, so a logo with a see-through background becomes a logo on a black square on somebody’s home screen. A good generator fills that one with a background colour for you.',
      },
      {
  ...
  'color-palette': {
    learn: [
      {
        title: 'A palette is a set of jobs, not a number of colours',
      ...
      {
        title: 'Why every colour needs its lighter and darker versions',
    ...
    faqs: [
      ...
      {
        q: 'Can I use these colours commercially?',
        a: 'Yes. A colour cannot be owned in any general sense, and nothing here is licensed. The only caution is copying a well-known company’s exact palette in the same industry, which is a trademark question rather than a colour one.',
      },
    ],
  },
    ...
    learn: [
      {
        ...
        body: 'It looks calm and expensive on a large bright screen in a dim office, which is exactly where design decisions get made. On a phone in daylight, or to eyes over about forty, or to the roughly one in twelve men with some colour blindness, it starts to disappear. Contrast is the one accessibility measure that is genuinely just a number — you can check it, and then you know.',
      },
      {
      ...
      },
      {
        ...
        body: 'Text on top of a photo, where the background changes from one corner to the next. Text on a coloured button, which is a foreground and a background you chose separately. Placeholder text in a form, which is almost always too faint. And the focus outline that shows where you are when navigating by keyboard — invisible on many sites, and the only way some people can use them at all.',
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: 'Because they are different colour pairings and each has to be checked separately. Pure white text on a pure black background is technically maximum contrast but causes visible smearing for many readers — slightly off-white on a very dark grey usually reads better and still passes comfortably.',
      },
    ],
  },
