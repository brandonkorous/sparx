...
import { ColourField, Panel, Problem, ToolLayout } from './ui-kit';
 ...
 * web; the white-on-mid-yellow one is what happens when a brand colour is
...
const COMMON_PAIRS: { label: string; note: string; fg: string; bg: string }[] = [
  ...
  },
  {
    ...
    note: 'The usual “secondary text” colour.',
    fg: '#6B7280',
    bg: '#FFFFFF',
  },
  {
    label: 'White on mid yellow',
    note: 'A brand colour used as a button fill.',
    fg: '#FFFFFF',
    bg: '#F3B61F',
  },
  {
 ...
 * page says is whether the colours work and at what size, in words.
 *
 ...
 * colour picker; suggesting the nearest shade of their own colour that passes is
...
export function ContrastTool() {
  ...
  /**
   * The nearest version of the SAME colour that passes.
   *
   ...
   * still recognisably their brand colour, which is why they will actually take
   * it. Suggesting an unrelated colour that happens to pass is advice nobody
   * follows.
   */
      ...
      form={
        <>
          <Panel
            ...
            description="The colour of the text, and whatever is behind it."
          >
            ...
            {!fgRgb || !bgRgb ? (
              <Problem>
                That is not a colour we can read. Use a six-digit hex code like{' '}
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    >
                      ...
                      {/* A semantic colour, not neutral: this badge distinguishes
 a pass from a failure, so the colour has to carry it. */}
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="mt-2 text-base">
                    The same colour, a little {suggestion.direction}. It passes at every size and is
                    close enough that nobody will notice it changed.
                  </p>
                  <div className="mt-4 flex flex-wrap items-center gap-3">
                    {/* Painted inline for the same reason as the preview below:
 this is the visitor's colour, not one of ours. */}
                    <span
                      aria-hidden
 ...
 *
 * The colours here are typed by a person, one keystroke at a time. There is no
