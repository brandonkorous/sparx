          ...
          <Card>
            <CardBody>
              ...
              <ul className="mt-3 flex flex-col gap-3 text-base">
                ...
                <li>
                  <strong>Black on white.</strong> Not on a coloured background, not in your brand
                  colour, not on a dark label. Red is effectively invisible to some older scanners.
                </li>
                <li>
