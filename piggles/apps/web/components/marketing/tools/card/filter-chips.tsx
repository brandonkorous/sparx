...
/** The chips carry their own group colour when chosen, so filtering to Money
      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={`rounded-selector border px-4 py-2 text-base font-semibold transition-colors duration-150 outline-none motion-reduce:transition-none ${
              on
