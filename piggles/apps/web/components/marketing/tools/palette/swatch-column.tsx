...
export function SwatchColumn({
    ...
    return (
        <div
            ...
            className={`group flex min-w-0 flex-1 touch-none flex-col transition-[flex-grow] duration-200 select-none max-lg:flex-none lg:cursor-grab lg:hover:grow-[1.4] ${dragging ? 'z-10 grow-[1.4] lg:cursor-grabbing' : ''
                }`}
        >
            <div
