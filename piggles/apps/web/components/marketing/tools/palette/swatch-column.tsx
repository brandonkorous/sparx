...
/**
 * One slot: a colour block, and the ink that goes on it in a band beneath.
 *
 * The role name at the top belongs to the SLOT, not to the colour — drag a
 * swatch two places left and the labels stay where they are while the colours
 ...
 * aligned through a hover-grow and travels with its colour on a drag.
 */
export function SwatchColumn({
   ...
   * surface showing text on that colour untouched. The card is the closest thing
   ...
   */
  ink: string | null;
  /** The ink band under the colour — outside it, and aligned to it. */
  foot: ReactNode;
  vision: Vision;
  removable: boolean;
  dragging: boolean;
   ...
   *
   * The caption said "takes dark text" — advice about the colour, which was fine
