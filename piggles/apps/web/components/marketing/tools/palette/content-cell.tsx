...
/**
 * The ink that goes ON this slot's color, under it and outside it.
 *
 ...
 * color block said it was. It sits in a band beneath instead.
 *
 ...
 * it aligned by construction — it travels with its color for free.
 *
 ...
 * color, and putting it in the band made the row uniform and gave `neutral`
        ...
        <div className="border-base-300 bg-base-100 flex h-16 items-center gap-1 border-t pr-1 pl-3">
            ...
            {overridden ? (
                <button
                    ...
                    aria-label={`Put ${pair.name} back to the worked-out color`}
                    title={`Put ${pair.name} back to the worked-out color`}
