 ...
 * saved by the older tool comes back with its colours in slots that mean nothing
...
export function usePalette(scheme: Scheme) {
   ...
   * array and the last one won — dragging the fourth colour to the front swapped
