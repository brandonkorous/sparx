...
/** The bar, the colours, and what to do with them — the part of the page
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-base">
        <strong>The job belongs to the position, not to the colour.</strong> Drag a swatch under a
        ...
        Keeping a colour pins it to the job it is doing, so shuffling leaves both alone.
      </p>
      ...
      {vision !== 'normal' ? (
        <Alert color="info" role="status">
          ...
          <AlertContent>
            ...
            <AlertDescription>
              {VISIONS[vision].blurb} The codes on each colour have not changed — only what is on
              the screen has.
            </AlertDescription>
          </AlertContent>
        </Alert>
