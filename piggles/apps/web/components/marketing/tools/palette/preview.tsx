 ...
 *
 * Five rectangles cannot tell you whether a set of colours works. The same five
 ...
 *
 * The one inline style on the wrapper is the visitor's own colours: there is no
