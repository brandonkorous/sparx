...
/**
 * What the palette looks like to somebody who does not see color the way you
 * do.
 *
 * Around one man in twelve has some form of color blindness, so a palette whose
...
export const VISIONS: Record<Vision, { label: string; blurb: string }> = {
    ...
    mono: { label: 'No color at all', blurb: 'Also what a black-and-white printout does to it.' },
};
