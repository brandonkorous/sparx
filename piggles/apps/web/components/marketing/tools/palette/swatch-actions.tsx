    ...
    return (
        <Tooltip content={label}>
            <button
                ...
                className={`grid size-9 place-items-center rounded-full border border-current transition-colors hover:bg-current/20 ${pressed ? 'bg-current/25 ring-2 ring-current' : ''
                    }`}
            >
