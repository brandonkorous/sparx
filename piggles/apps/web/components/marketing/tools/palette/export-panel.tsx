    ...
    <Card>
      <CardBody>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {/* No `color` — uncoloured resolves to `base-content` and stays right
        ...
        <Tabs defaultValue="silica" className="mt-2">
          ...
          <TabsPanel value="silica">
            <CodeOut
              ...
              language="css"
              hint="A whole theme. Paste it into your stylesheet and every button, badge, input and tab picks these up at once — there is nothing else to change. The readable ink on each colour is worked out for you, so only the inks you changed yourself appear here."
            />
          </TabsPanel>
          <TabsPanel value="css">
            <CodeOut
              code={cssVars(palette, roles)}
              hint="Named by what each colour does, so the names still make sense after you reorder them."
            />
          </TabsPanel>
