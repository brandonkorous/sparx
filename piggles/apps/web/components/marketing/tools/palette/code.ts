 ...
 * the palette an hour later. `--color-3` does neither. Anything no role claimed
 ...
 *
 * ── ONE LINE PER COLOR, AND NOTHING ELSE ───────────────────────────────────
 *
 ...
 * any swatch's shades rail, where every color gets it equally; what leaves the
 ...
 * exports is not always the color sitting in it: `base-content` is darkened
