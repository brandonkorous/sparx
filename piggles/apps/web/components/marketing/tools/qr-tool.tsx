      ...
      form={
        <>
          ...
          <Panel title="How it looks">
            <ColourField label="The pattern" value={dark} onChange={setDark} />
            <ColourField label="Behind it" value={light} onChange={setLight} />

            {contrast < 4 ? (
              <Problem>
                These two colours are too close together for a scanner to tell apart. A phone camera
 ...
 * pattern.
 *
 * The colours here come from what somebody typed. There is no token for a
 * visitor's brand colour and there cannot be — this is the artefact, not our
