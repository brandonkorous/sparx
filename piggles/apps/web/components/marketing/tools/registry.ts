 ...
 * entry in the sitemap, the colour the page wears, and the app it hands you on to
 * at the bottom.
 *
...
export interface PigglesTool {
   ...
   *  colour (through the app's group) and the destination of the close. */
  app: string;
...
export const TOOLS: readonly PigglesTool[] = [
  ...
  },
  {
    ...
    name: 'QR code maker',
    tagline:
      'A code people scan with a phone camera — for a menu, a table, a shelf tag, your Wi-Fi, or your own contact details. Your colours, your logo, no expiry.',
    description:
      'Free QR code generator. Turn a web address, a message, your Wi-Fi login, your contact details, an email or a phone number into a sharp, scannable code. Choose the colours, drop your logo in the middle, and download a PNG for printing or an SVG that stays crisp at any size — poster or business card. No sign-up, no watermark, and it never stops working.',
    keywords: [
      'qr code generator',
      'free qr code',
      'wifi qr code',
  ...
  },
  {
    ...
    description:
      'Free social share image maker. Design the 1200 × 630 preview card that appears when your link is pasted into a message, a post or a group chat — a headline, your colour, your logo, light or dark — and download a PNG ready to use as your og:image. It is the difference between a link that looks published and one that looks pasted.',
    keywords: [
  ...
  },
  {
    ...
    description:
      'Free email signature generator. Put in your name, what you do, your phone number and your links, pick a layout and a colour, and copy a clean signature straight into Gmail, Outlook or Apple Mail. Built the sturdy, old-fashioned way that survives every mail app — including the ones that break everything else.',
    keywords: [
  ...
  },
  {
    ...
    description:
      'Free brand colour palette generator. Press space for a new set, keep the ones worth keeping and re-roll the rest, drag them into the order you want, and open any colour for every lighter and darker step. Then see the palette on an actual shop page, a phone and an invoice — with which colour is the button and which is the writing worked out for you, every readable pairing measured, and a check for how it all looks to somebody who is colour blind. Take it away as a silicaui theme, CSS variables, Tailwind, SCSS, a picture, or just the link.',
    keywords: [
    ...
    icon: faPalette,
    ladder: {
      headline: 'Choosing the colours is the fun part.',
  ...
  },
  {
    ...
    description:
      'Free colour contrast checker. Put in a text colour and a background colour and get the exact ratio, whether it passes the accessibility standards for normal and large text, and a live preview at real sizes. Pale grey on white looks refined on your screen and disappears on a phone in daylight — this is how you find out before a customer does.',
    keywords: [
      'contrast checker',
      'wcag contrast',
 ...
 * shared photo per group reinforces the same grouping the colour already
 * carries.
 */
...
/** The colour a tool page wears — its app's group hue, never a hue of its own.
 *  Six groups is the whole colour system (DESIGN.md §2); a tools section that
 ...
 * a colour palette than a barcode — then the rest in catalog order to fill up.
