 ...
 * color, a real typographic hierarchy, and one confident accent do the job and
...
export const CARD_LAYOUTS: { value: CardLayout; label: string; blurb: string }[] = [
  {
    value: 'left',
    label: 'Left',
    blurb: 'Everything ranged left, with a color bar down the side. Reads like a headline.',
  },
  {
    value: 'centre',
    label: 'Centred',
  ...
  },
  {
    value: 'split',
    label: 'Split',
    blurb: 'A solid color panel on the left, the words on the right.',
  },
];
...
export function drawShareCard(canvas: HTMLCanvasElement, input: CardInput): void {
  ...
  // The text color is MEASURED against the background rather than chosen, which
