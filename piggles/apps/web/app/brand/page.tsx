...
const BRAND_ROLES = [
  ...
  },
  {
    ...
    note: 'Deep charcoal — the wordmark colour',
    ratio: '12.47',
  },
  {
    token: 'accent',
...
function GroupBlock({ group }: { group: PigglesGroup }) {
  ...
  return (
    ...
    // everything inside use `module` and land on the right hue with no colour
  ...
  return (
    <div data-theme={theme} className="bg-base-200 text-base-content rounded-box p-6">
      ...
      <Section title="Controls">
        ...
        <p className="mt-3 text-sm">
          The Delete button and the brand pink must never read as the same colour — the reason dark{' '}
