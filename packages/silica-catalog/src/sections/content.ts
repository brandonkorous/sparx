 ...
 *
 * Four tones, each SAYING what it is rather than relying on color alone: somebody
 * reading in greyscale, or with a color vision difference, gets the same warning.
