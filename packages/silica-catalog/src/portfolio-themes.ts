...
// accent-free like runway — the photographs are the only colour), void (terminal black in
...
const silver = defineTheme({
  ...
  // role is a muted graphite for whisper-labels only; every ounce of colour comes from the
...
const atlas = defineTheme({
  ...
  // structure, flat — the large-format work is the colour, the chassis stays quiet.
  name: 'atlas',
