...
//
//   - @sparx/cms-schemas re-exports it as `ContentTypeSchema` to describe a
//     `content_entries.body` (a content type's fields).
//   - @sparx/commerce-schemas re-exports it as `ProductTypeSchema` to describe
...
//
// This module was extracted out of @sparx/cms-schemas (docs/143 §3) so that a
