...
function card(children: BuilderNode[]): BuilderNode {
  return node('Section', {
    box: { backgroundWidth: 'full', contentWidth: 'full', padding: 'md', backgroundImage: tint(TINT.white) },
  ...
  return node('Stack', {
    ...
    children: [
      card([
        ...
        node('Text', { props: { variant: 'body', text: 'Goals, scope, and timeline — all on one page.' } }),
        node('Text', { props: { variant: 'meta', text: 'Shared with 4 people · edited just now' } }),
      ]),
      card([
...
function heroPreviewCard(): BuilderNode {
  const tile = (label: string, hex: string): BuilderNode =>
    node('Section', {
      box: { backgroundWidth: 'full', contentWidth: 'full', padding: 'md', align: 'center', backgroundImage: tint(hex) },
      layout: { direction: 'stack', gap: 'none', justify: 'center', alignItems: 'center' },
      cls: 'bx-panel',
      children: [node('Text', { box: { align: 'center' }, props: { variant: 'body', text: label } })],
    });
  return node('Section', {
    box: { name: 'App preview', backgroundWidth: 'full', contentWidth: 'full', padding: 'lg', backgroundImage: tint(TINT.white) },
    ...
    children: [
      ...
      node('Grid', {
        ...
        children: [tile('📄  Docs', TINT.coral), tile('✓  Projects', TINT.mint), tile('📚  Wiki', TINT.violet)],
      }),
    ],
  });
}
...
function plansGrid(): BuilderNode {
  const plan = (opts: {
    ...
    node('Card', {
      box: opts.featured
        ? { surface: 'brand', backgroundWidth: 'full', contentWidth: 'full', padding: 'lg', align: 'start' }
        : {
            backgroundWidth: 'full',
            contentWidth: 'full',
            padding: 'lg',
...
function homeTree(): BuilderNode {
  const featureCard = (heading: string, body: string): BuilderNode =>
    node('Card', {
      box: { backgroundWidth: 'full', contentWidth: 'full', padding: 'lg', align: 'start', backgroundImage: tint(TINT.white) },
      layout: { direction: 'stack', gap: 'sm' },
      cls: 'bx-card',
      children: [
  ...
  return node('Section', {
    ...
    children: [
      ...
      node('Section', {
        box: { name: 'Hero', height: 'full', surface: 'none', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'xl' },
        layout: { direction: 'stack', gap: 'lg', justify: 'center', alignItems: 'center' },
        children: [
          node('Heading', {
            box: { align: 'center' },
            props: { level: 'h1', size: 'display', text: 'One workspace for your docs, projects, and knowledge' },
          }),
          node('Text', {
            box: { align: 'center' },
            props: {
          ...
          node('Stack', {
            ...
            children: [
              ...
              node('Button', { props: { label: 'Request a demo', style: 'soft', href: '/contact' } }),
            ],
          }),
          node('Text', {
            box: { align: 'center' },
      ...
      node('Section', {
        box: { name: 'Logo cloud', surface: 'none', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'lg' },
        layout: { direction: 'stack', gap: 'md', alignItems: 'center', justify: 'center' },
        children: [
          node('Text', { props: { variant: 'meta', text: 'Powering focused teams at companies of every size' } }),
          node('Stack', {
            box: { padding: 'none', align: 'center' },
            layout: { direction: 'row', gap: 'lg', justify: 'center', alignItems: 'center', wrap: true },
            children: [
      ...
      node('Section', {
        box: { name: 'Everything you need', surface: 'none', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'xl' },
        layout: { direction: 'stack', gap: 'md', alignItems: 'center', justify: 'center' },
        children: [
          node('Heading', { props: { level: 'h2', text: 'Everything your team needs, in one place' } }),
          node('Text', { props: { variant: 'body', text: 'Replace scattered tools with a single workspace that adapts to how you work.' } }),
          node('Grid', {
            box: { padding: 'none', align: 'start' },
            layout: { direction: 'grid', columns: 3, gap: 'lg' },
            children: [
              featureCard('Docs & notes', 'Beautiful, block-based pages for everything from meeting notes to specs.'),
              featureCard('Projects', 'Boards, timelines, and calendars that stay in sync across your team.'),
              featureCard('Wikis', 'A connected knowledge base your whole company can actually find.'),
              featureCard('Calendar', 'Plans, deadlines, and meetings tied directly to your work.'),
              featureCard('Mosaic AI', 'An assistant that drafts, answers, and automates across your workspace.'),
              featureCard('Integrations', 'Connect the tools you already use — and bring their data into Mosaic.'),
            ],
          }),
        ],
      }),
      ...
      node('Section', {
        box: { name: 'Stats', surface: 'none', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'xl' },
        layout: { direction: 'stack', gap: 'none' },
        children: [
          node('Grid', {
            box: { padding: 'none', align: 'center' },
            ...
            children: [
              node('Stat', { box: { align: 'center' }, props: { value: '100k+', label: 'Teams onboard' } }),
              node('Stat', { box: { align: 'center' }, props: { value: '12→1', label: 'Tools consolidated' } }),
              node('Stat', { box: { align: 'center' }, props: { value: '4.8/5', label: 'Average rating' } }),
              node('Stat', { box: { align: 'center' }, props: { value: '99.9%', label: 'Uptime, every month' } }),
            ],
          }),
        ],
      }),
      ...
      node('Section', {
        box: { name: 'Testimonial', surface: 'subtle', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'xl' },
        layout: { direction: 'stack', gap: 'md', alignItems: 'center', justify: 'center' },
        children: [
          node('Heading', {
            props: {
          ...
          node('Text', { props: { variant: 'body', text: 'Dana Okafor · Head of Operations, Brightline' } }),
        ],
      }),

      // PRICING TEASER.
      node('Section', {
        box: { name: 'Pricing', surface: 'none', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'xl' },
        layout: { direction: 'stack', gap: 'md', alignItems: 'center', justify: 'center' },
        children: [
          node('Heading', { props: { level: 'h2', text: 'Simple pricing that scales with you' } }),
          node('Text', { props: { variant: 'body', text: 'Start free. Upgrade when your team grows. Cancel anytime.' } }),
          plansGrid(),
        ],
      }),
      ...
      node('Section', {
        box: { name: 'CTA', surface: 'inverse', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'xl' },
        layout: { direction: 'stack', gap: 'sm', alignItems: 'center', justify: 'center' },
        children: [
          node('Heading', { props: { level: 'h2', text: "Your team's next workspace starts here" } }),
          node('Text', { props: { variant: 'body', text: 'Get started free — bring your team in minutes, not months.' } }),
...
function pricingPageTree(): BuilderNode {
  return node('Section', {
    box: { name: 'Pricing', padding: 'xl', backgroundWidth: 'full', contentWidth: 'contained', align: 'center' },
    layout: { direction: 'stack', gap: 'md', alignItems: 'center', justify: 'center' },
    children: [
...
function blogIndexTree(): BuilderNode {
  return node('Section', {
    box: { name: 'Blog', padding: 'xl', backgroundWidth: 'full', contentWidth: 'contained', align: 'start' },
    layout: { direction: 'stack', gap: 'md' },
    children: [
      node('Heading', { props: { level: 'h1', text: 'Resources' } }),
      node('Text', { props: { variant: 'body', text: 'Guides, playbooks, and ideas for working better, together.' } }),
      node('Grid', {
        box: { padding: 'none' },
        layout: { direction: 'grid', columns: 3, gap: 'lg' },
        bind: 'cms.blog_post',
...
function blogPostTree(): BuilderNode {
  return node('Section', {
    ...
    children: [
      node('Section', {
        box: { name: 'Header', surface: 'subtle', backgroundWidth: 'full', contentWidth: 'contained', align: 'center', padding: 'xl' },
        layout: { direction: 'stack', gap: 'sm', alignItems: 'center', justify: 'center' },
        children: [
...
function siteLayoutTree(): BuilderNode {
  ...
  return node('Section', {
    ...
    children: [
      ...
      node('Section', {
        box: { name: 'Header', surface: 'none', backgroundWidth: 'full', contentWidth: 'contained', padding: 'md' },
      ...
      node('Section', {
        box: { name: 'Footer', surface: 'muted', backgroundWidth: 'full', contentWidth: 'contained', padding: 'xl' },
        ...
        children: [
          ...
          node('Text', { props: { variant: 'meta', text: '© Mosaic. One workspace for your whole team.' } }),
        ],
      }),
    ],
  });
...
function welcomeEmailTree(): BuilderNode {
  return node('Section', {
    ...
    children: [
      ...
      node('Button', { props: { label: 'Open your workspace', href: '' }, box: { align: 'start' } }),
      node('Divider'),
...
function tipsEmailTree(): BuilderNode {
  return node('Section', {
    ...
    children: [
      ...
      node('Divider'),
      node('Text', { props: { variant: 'meta', text: 'You can manage email preferences anytime.' } }),
    ],
  });
}
...
const manifest = {
  ...
  content: [
    {
      ...
      body: {
        ...
        excerpt: 'A wiki is only useful if it stays current. Here is how to structure one that does.',
        body: doc(
    ...
    },
    {
      ...
      body: {
        ...
        excerpt: 'Consolidating tools is less about migration and more about a shared home for work.',
        body: doc(
    ...
    },
    {
      ...
      body: {
        ...
        excerpt: 'Plans, tasks, and docs belong together. Here is a lightweight way to keep them in sync.',
        body: doc(
  ...
  pages: [
    { name: 'Home', kind: 'singleton' as const, tree: homeTree(), seoTitle: 'Mosaic — one workspace for your whole team' },
