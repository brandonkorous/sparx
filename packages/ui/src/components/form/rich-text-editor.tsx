...
function ToolDivider() {
    return <span aria-hidden className="mx-1 h-4 w-px bg-base-300" />;
}
        ...
        editorProps: {
            attributes: {
                ...
                class: cn(
                    ...
                    '[&_blockquote]:text-base-content/70 [&_blockquote]:my-2 [&_blockquote]:border-l-2 [&_blockquote]:border-base-300 [&_blockquote]:pl-3',
                    '[&_code]:rounded [&_code]:bg-base-200 [&_code]:px-1 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-xs',
                    '[&_pre]:my-2 [&_pre]:rounded-md [&_pre]:bg-base-200 [&_pre]:p-3 [&_pre]:text-xs'
                ),
            },
        },
    });
    ...
    return (
        ...
        >
            <div
                ...
                className="flex flex-wrap items-center gap-0.5 border-b border-base-300 p-1"
            >
                <ToolButton
                    label="Bold"
