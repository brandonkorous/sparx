...
>(({ className, ...props }, ref) => (
    <tbody
        ref={ref}
        className={cn(
            '[&_tr]:border-b [&_tr]:border-base-300 [&_tr:last-child]:border-0',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <tfoot
        ref={ref}
        className={cn(
            'border-t border-base-300 bg-base-200 font-medium',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <tr
        ref={ref}
        className={cn(
            'data-[state=selected]:bg-module/10 transition-colors duration-100 hover:bg-base-200',
            className
        )}
        {...props}
    />
