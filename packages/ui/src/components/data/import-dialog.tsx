...
import { Label, Progress, Switch } from '@wizeworks/silicaui-react';
      ...
      <ModalContent size="xl">
        ...
        {phase === 'progress' && (
          <Stack gap={6} className="mt-4 items-center py-8">
            <div className="border-t-module border-base-300 h-12 w-12 animate-spin rounded-full border-4" />
            ...
            {/* No `value` → silica's indeterminate (unknown-duration) bar. */}
            <Progress color="primary" className="w-full max-w-xs" />
          </Stack>
        )}
          ...
          <Stack gap={5} className="mt-4">
            ...
            {result.errorCount > 0 && (
              <Stack gap={3}>
                ...
                <div className="border-base-300 max-h-48 overflow-y-auto rounded-lg border">
                  <table className="w-full text-xs">
                    <thead className="bg-base-200">
                      <tr>
                    ...
                    <tbody>
                      {result.rows
                        ...
                        .map((r) => (
                          <tr key={r.rowIndex} className="border-base-300 border-t">
