    ...
    return (
        ...
        >
            <Stack
                ...
                className="bg-module bg-soft rounded-xl border border-base-300 px-4 py-2.5"
            >
                ...
                <Stack
                    ...
                    align="center"
                    gap={2}
                    className="border-r border-base-300 pr-2"
                >
            ...
            destructive never sits next to whatever's clicked most often). */}
                {orderedActions(actions).map((group, gi) => (
                    <React.Fragment key={gi}>
                        {gi > 0 && <div aria-hidden className="h-5 w-px shrink-0 bg-base-300" />}
