...
// View-HTML / import pair; View HTML (serialize) lives in @sparx/builder-render.
//
...
// `@sparx/surface-compile` (the server-only Tailwind package); rather than couple
...
/** A class-token validator (the shape of `@sparx/surface-compile`'s
