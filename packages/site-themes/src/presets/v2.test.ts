...
describe('platform base preset', () => {
  it('states every colour slot as a hex, in both modes', () => {
  ...
  // colour live and compiled another. Ember on both sides is the fix; this holds it.
  ...
  // STATUS text must clear AA for normal text (4.5) on its own fill. These colours
