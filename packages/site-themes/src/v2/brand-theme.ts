...
// to that point the site is rendered from the tenant's BRAND, compiled. So "what color
...
// would eventually disagree, and the failure mode is a check that judges a color the
// visitor never sees.
//
