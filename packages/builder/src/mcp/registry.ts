...
// transports. The MCP server imports `builderMcpTools` (via the `@sparx/builder/mcp`
...
// service functions. Mirrors packages/sitebuilder/src/mcp/registry.ts.
//
// NOTE these are the NEW node-tree page tools (Tailwind-native `class` authoring).
// @sparx/sitebuilder's tools (add_section, select_theme, …) drive the separate
