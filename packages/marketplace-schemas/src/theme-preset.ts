...
/** The v1 storefront token surface (mirrors @sparx/site-themes ThemeTokens). */
...
/** One mode's v2 color slots (mirrors @sparx/site-themes ColorTokensV2). The
...
/** Mode-independent v2 tokens (mirrors @sparx/site-themes SharedTokensV2). */
...
/** A complete v2 preset (mirrors @sparx/site-themes ThemePresetV2). */
