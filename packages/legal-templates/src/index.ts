...
// of packages/sitebuilder-schemas/src/page-templates.ts.
//
// Dependency-free on purpose: the doc nodes are plain JSON in the ProseMirror
// shape `@sparx/cms-editor`'s renderDocToHtml consumes (doc → paragraph /
// heading / bulletList / listItem / callout). No @sparx/cms-editor import so
