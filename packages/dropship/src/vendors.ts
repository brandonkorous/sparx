...
//
// This module is PURE DATA — it imports no adapter code and no `@sparx/db`, so
// the dashboard can import it from a client component via the `@sparx/dropship/
...
export const VENDOR_CATALOG: DropshipVendor[] = [
  ...
  },
  {
    ...
    credentialFields: [
      ...
      // multiple variants (e.g. one row per size/colour); Title/SKU/Cost are
