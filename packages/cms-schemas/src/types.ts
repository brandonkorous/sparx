...
// recursive union schema) now lives in the neutral @sparx/field-schema package
...
// from '@sparx/cms-schemas'` keeps resolving exactly as before.
//
...
export type { FieldDef, ObjectFieldDef, RepeaterFieldDef } from '@sparx/field-schema';
export { FieldDefSchema } from '@sparx/field-schema';
...
export { FieldSchema as ContentTypeSchema } from '@sparx/field-schema';

import type { FieldSchema } from '@sparx/field-schema';
