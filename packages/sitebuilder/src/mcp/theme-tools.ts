...
// brand snapshot (colours / fonts / shape) under a name, so a site can wear a
...
export const themeTools: AnyMcpTool[] = [
  ...
  },
  {
    ...
    description:
      'Create a named custom theme from a base preset + a presentation overlay + a brand snapshot (colours, fonts, ' +
