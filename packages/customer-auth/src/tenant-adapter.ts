...
// shared @sparx/db client that does exactly two things and nothing else, so all
...
import { prisma, tenantStore, withTenant, type TxClient } from '@sparx/db';

// Better Auth model key → real @sparx/db Prisma delegate key. Core keys are the
