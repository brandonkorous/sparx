...
// types (docs/143), the commerce mirror of @sparx/cms's content-types-service.
//
...
//     Zod validator built from the resolved type's schema (@sparx/field-schema
//     bodyValidatorFor), 422 on mismatch, exactly like a content entry body.

import type { Prisma, ProductType, TxClient } from '@sparx/db';
import { withTenant } from '@sparx/db';
import { bodyValidatorFor } from '@sparx/field-schema';
import {
  ProductTypeSchema,
