...
// `CollectionPredicate` in @sparx/commerce-schemas, and THIS compiler
...
import { CollectionRuleSet } from '@sparx/commerce-schemas';
import type { CollectionPredicate } from '@sparx/commerce-schemas';
