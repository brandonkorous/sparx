...
//
// A peer of @sparx/builder's emailService in the builder framework — same
...
import { DEFAULT_INVOICE_TEMPLATE } from '@sparx/crm-schemas/builtins';
import { withTenant } from '@sparx/db';
import type { BillingDocumentTemplate, Prisma } from '@sparx/db';
