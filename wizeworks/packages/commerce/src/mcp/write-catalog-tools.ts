...
const assignVariantOptionValues: McpToolDefinition = {
  ...
  description:
    'Map a variant onto the product’s option lattice by listing the option-value ids it represents (e.g. Size=M, Color=Red). The set must span every option exactly once.',
  scope: 'write:commerce',
  confirmation: true,
