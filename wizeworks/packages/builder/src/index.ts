// @wizeworks/builder — public package barrel.
//
...
// (node tree + page shapes + starter pages) lives in @wizeworks/builder-schemas,
...
export type { SiteChromeOptions } from '@wizeworks/silica-catalog';
