...
// iterates to register tools. Imported via the `@wizeworks/builder/mcp` subpath so the
...
// the site's ONLY chrome tier reads `.silica_published_tree` (wizeworks/apps/site/app/
