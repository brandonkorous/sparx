...
// and `preheader`. Trees are validated against @wizeworks/builder-schemas on every
...
import type { BuilderEmail } from '@wizeworks/db';
 ...
 *  default tree shipped in `@wizeworks/builder-schemas`, so a transactional send never
