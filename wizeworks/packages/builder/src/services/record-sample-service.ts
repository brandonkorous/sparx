...
// own predicate — active/published, not soft-deleted, and `@wizeworks/db`'s Model B site
...
import { RECORD_ADDRESSES, type RecordAddress } from '@wizeworks/silica-catalog';
import {
...
> = {
  ...
  // A published entry of the blog type WITH a slug: wizeworks/apps/site's `/blog/[slug]` route
