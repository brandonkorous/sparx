...
// @wizeworks/builder-schemas: safe to import from editor client components AND the
...
// matches the package's "catalog data is validated by @wizeworks/builder-schemas, never
