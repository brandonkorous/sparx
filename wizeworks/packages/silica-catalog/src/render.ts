...
// structural (docs/118 §1.1). Both the storefront (`wizeworks/apps/site`) and the publish
 ...
 * projection below, and `wizeworks/apps/site`'s React chrome, which renders the frame and the body
