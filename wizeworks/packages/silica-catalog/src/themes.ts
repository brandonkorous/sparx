...
// presets in @wizeworks/site-themes.
//
...
const field = defineTheme({
  ...
  //
  // A muted green page at 92% — the color of work done outdoors, rather than a white
...
const harbor = defineTheme({
  ...
  //
  // Deep navy and signal orange — the two colors every working port already uses,
...
const studio = defineTheme({
  ...
  // surface, one hot magenta reserved for interaction. The work supplies the color;
