// Unit tests for @wizeworks/media. The security-relevant REJECTIONS (mime allowlist,
...
// mock @wizeworks/db + @wizeworks/events so we can assert the object write + the
