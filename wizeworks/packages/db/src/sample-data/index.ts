...
// production load/clear seam (wizeworks/services/api-rest/src/lib/sample-data.ts) both
...
import { floristPack } from './packs/florist';
...
export const SAMPLE_DATA_PACKS: Record<string, SampleDataPack> = {
  ...
  [floristPack.industry]: floristPack,
