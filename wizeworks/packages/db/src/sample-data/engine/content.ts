...
//
// `body` is written raw (no validateAndNormalizeBody — that lives in @wizeworks/api-core,
// which @wizeworks/db can't import; the legal-page backfill writes raw the same way).
