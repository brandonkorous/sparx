...
//
//   pnpm --filter @wizeworks/db db:report:record-pages
//
...
// migration itself uses, for the same reason (wizeworks/packages/db/CLAUDE.md, "Backfilling a
...
// dependency of this package — pnpm links it into `wizeworks/packages/db/node_modules` only, so
