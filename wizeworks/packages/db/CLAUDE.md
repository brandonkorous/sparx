# wizeworks/packages/db — database, migrations, RLS

Scoped guidance for `@wizeworks/db`. Loads when working in this package. See root [CLAUDE.md](../../CLAUDE.md) for cross-cutting rules.
