...
// unset → the @wizeworks/events publisher falls back to its logging (no-op) transport, so
...
const EnvSchema = z.object({
  ...
  // `@wizeworks/links/server` reads every such variable, in one fixed order, once.
