...
import { constraintsFor, type MediaRef, type SocialPlatform } from '@wizeworks/social';
 ...
 *  perceptually, not numerically). Pure over @wizeworks/social constraints — the ONE
