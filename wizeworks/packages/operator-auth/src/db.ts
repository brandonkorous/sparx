...
//
// This is deliberately NOT the shared @wizeworks/db Prisma client. The operator app
...
// connections (mirrors @wizeworks/db's client + @wizeworks/auth's authPrisma).
...
function connectionString(): string {
  ...
  // complete, which is the same call wizeworks/packages/events/src/transport.ts makes for
  ...
  // wizeworks/packages/db/docker/init/01-roles.sql.
