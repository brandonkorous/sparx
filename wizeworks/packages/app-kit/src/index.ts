// @wizeworks/app-kit — the framework glue every sparx Next.js app needs.
//
// Deliberately NOT @wizeworks/ui: nothing here has an appearance, a variant, or a
// token. @wizeworks/ui is the composition layer an app's designers work in; this is
