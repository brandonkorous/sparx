// @wizeworks/social — public barrel.
//
...
// `@wizeworks/social/crypto` subpath so the composer bundle never pulls node:crypto.
...
// The shared-plane face of the platform catalog (@wizeworks/integrations).
export {
  socialIntegrations,
