...
// on publish), NEVER by the composer UI. Reached via the `@wizeworks/social/crypto`
// subpath. Shares the exact bundle format + algorithm as @wizeworks/channels/crypto.
//
