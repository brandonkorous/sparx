...
/** A color swatch. The fill is PRODUCT DATA (the option value's own hex), so it
 ...
 *  an inline `style` either. Subtree color via a scoped `<style>` block is the
 *  sanctioned pattern in this repo (sparx/apps/web's `ThemePreview` does the same thing
...
// selected variant + the product's currency. (Mirrors wizeworks/apps/site lib/format.)
