...
//
//   · LIVE (wizeworks/apps/site): a <BuilderRuntimeProvider> high in the storefront tree
//     bridges these calls to the real <CartProvider>/<CustomerProvider> hooks,
//     which stay in apps/site. See wizeworks/apps/site/components/site-builder-runtime.
 ...
 *  by the live storefront (bridged from wizeworks/apps/site's CustomerProvider); left
 ...
 *  The live bridge (wizeworks/apps/site) adds the trusted scoping (tenant/site slug + the
 ...
 *  wizeworks/apps/site, inside the cart/customer providers it bridges to. */
