// @wizeworks/email-sequences — the reusable multi-touch email JOURNEY (docs/81 §9).
//
...
//
// Backend-safe like @wizeworks/email-sends: depends ONLY on @wizeworks/db + @wizeworks/email-sends
