...
// bundle — hence the dedicated `@wizeworks/email/silica` entrypoint.
//
// The pipeline (D2):
...
import { emailBrandFontHref } from '@wizeworks/site-themes';
import {
...
export interface RenderSilicaEmailOptions {
  /** The resolved tenant/site brand — colors, fonts, logo, and site name for the
