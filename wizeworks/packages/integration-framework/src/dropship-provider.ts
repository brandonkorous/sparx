...
// bespoke `@wizeworks/dropship` `SupplierAdapter` (wizeworks/packages/dropship) + the
...
// against this interface — extend `@wizeworks/dropship` instead.
//
...
import type { Currency, MoneyCents } from '@wizeworks/commerce-schemas';
