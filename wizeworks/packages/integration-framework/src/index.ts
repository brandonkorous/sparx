// @wizeworks/integration-framework — provider plug-in SDK.
//
// Concrete provider packages (@sparx/provider-stripe, @wizeworks/provider-shippo,
...
// Payments are NOT a provider kind — they belong to @wizeworks/payments' gateway
...
// billing is built for real it will be a gateway capability in @wizeworks/payments, next
