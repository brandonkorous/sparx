...
export { AddressSnapshot, Currency, LineItemInput, Money } from '@wizeworks/crm-schemas';
export type {
...
// address; this matches the AddressSnapshot constraint in @wizeworks/crm-schemas.
