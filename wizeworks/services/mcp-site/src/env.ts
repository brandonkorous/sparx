// Boot-time env validation (mirrors wizeworks/services/api-mcp/src/env.ts).
...
const EnvSchema = z.object({
  ...
  SITE_MCP_PUBLIC_ORIGIN: z.string().optional(),
});
...
function parseEnv(): Env {
  ...
  if (!result.success) {
    console.error('[mcp-site] invalid environment:');
