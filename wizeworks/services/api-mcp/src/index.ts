...
async function main(): Promise<void> {
  ...
  // WITHOUT this, `@wizeworks/api-core/pubsub`'s publish() fell back to the stdout stub
  ...
  // separately below (their own module state), and tools that emit via @wizeworks/events
