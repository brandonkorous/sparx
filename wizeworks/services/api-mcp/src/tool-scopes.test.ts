...
// grantable-scope catalog in @wizeworks/auth never learned about them. Nothing failed
...
import { MCP_BUSINESS_SCOPES, grantableScopesForRole } from '@wizeworks/auth';
