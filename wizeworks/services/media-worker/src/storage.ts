...
// wizeworks/services/api-rest/src/lib/storage.ts uses so the two services stay coherent
...
// identical switch `wizeworks/packages/media` (`getStorage()`) and api-rest already make,
