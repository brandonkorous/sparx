...
//
//   pnpm --filter @wizeworks/api-rest seed:demo            # provision every demo tenant
//   pnpm --filter @wizeworks/api-rest seed:demo --only demo-salon
//   pnpm --filter @wizeworks/api-rest seed:demo --drop demo-salon   # tear one down (cascades)
//
...
import { registerCrmConsumers } from '@wizeworks/crm';
