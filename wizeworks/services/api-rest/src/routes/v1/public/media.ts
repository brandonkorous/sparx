...
// (GET /v1/public/media/<id>?tenant=<slug>, see wizeworks/apps/site/lib/media.ts +
// wizeworks/services/api-rest/src/lib/email-data.ts). mediaPublicUrl() returns the CDN/
