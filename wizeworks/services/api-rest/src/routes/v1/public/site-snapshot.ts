...
// public site (wizeworks/apps/site) renders.
//
...
// in-flight clients keep working; remove once wizeworks/apps/site + any external callers
// are on `/v1/public/site`.

import type { FastifyPluginAsync, FastifyRequest } from 'fastify';
import { z } from 'zod';
import { isModuleEnabled } from '@wizeworks/auth';
import { publishService } from '@wizeworks/sitebuilder';
