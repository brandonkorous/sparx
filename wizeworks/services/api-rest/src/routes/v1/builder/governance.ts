...
// injection guards) is hardcoded in @wizeworks/surface-compile and NEVER relaxable —
...
import { z } from 'zod';
import { governanceService } from '@wizeworks/builder';
...
// "unblock" key — base rules live only in @wizeworks/surface-compile.
