...
// which keeps this whole feature off the migration pipeline (see wizeworks/packages/db/CLAUDE.md
...
// by `@wizeworks/migration`. This layer re-checks rather than trusts: the same validator
