// Import-worker Cloud Run entrypoint.
//
// Pub/Sub pushes `import.job.created` events to POST / — we decode the OIDC
// token, dispatch to handle(), and respond 204 (ack) or 5xx (nack/retry).
//
