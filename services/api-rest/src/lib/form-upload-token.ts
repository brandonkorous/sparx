...
// (docs/115 Part D). The forms analogue of @sparx/media's upload-token — a distinct
...
// Signed with SPARX_INTERNAL_JWT_SECRET — the SAME secret api-mcp/api-rest/@sparx/media
