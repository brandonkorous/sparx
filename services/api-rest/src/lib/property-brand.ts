...
export const PropertyBrandOverrideSchema = z
  .object({
    // Identity — the per-site display name, tagline, logos, and colour palette.
    ...
    // Brand colours + their optional -content (foreground) overrides.
    ...
    // Presentation — per-site surface colours and shape (legacy fields kept for
