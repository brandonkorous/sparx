...
//
// This lives in api-rest rather than in @sparx/crm for the same reason
...
// @sparx/crm a transport dependency to send one email would be paying for it in
...
import type { BillingDocumentSignature } from '@sparx/db';
