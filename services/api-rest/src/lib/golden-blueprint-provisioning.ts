...
// because `installBlueprint` already lives here and pulls in @sparx/builder /
// @sparx/sitebuilder / @sparx/blueprints — api-rest is the only place all of that,
...
//     `tenant.created`. That event is published from @sparx/auth's signup, which runs
...
import { startConsumer, type RunningConsumer } from '@sparx/events';
