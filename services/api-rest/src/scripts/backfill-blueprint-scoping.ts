...
//
//   pnpm --filter @sparx/api-rest ops:backfill-blueprint-scoping                 # dry run
//   pnpm --filter @sparx/api-rest ops:backfill-blueprint-scoping -- --apply
//   pnpm --filter @sparx/api-rest ops:backfill-blueprint-scoping -- --tenant=wizeworks
//
// ── WHY THIS EXISTS ────────────────────────────────────────────────────────────
...
// would return zero rows and exit looking successful (packages/db/CLAUDE.md). The two
