...
//
//   pnpm --filter @sparx/api-rest ops:backfill-finance-categories            # dry run
//   pnpm --filter @sparx/api-rest ops:backfill-finance-categories -- --apply
//
// ── WHY THIS EXISTS ───────────────────────────────────────────────────────────
...
//
// `packages/finance-worker` now consumes `module.activated` and provisions on
...
import { provisionFinance } from '@sparx/finance';
