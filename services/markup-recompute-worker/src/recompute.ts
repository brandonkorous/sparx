...
//
// The pure cost→price math + snapshot come from @sparx/commerce-schemas'
...
// it borrows nothing from @sparx/commerce (which carries React deps a worker
...
import type { MarkupRule, TxClient } from '@sparx/db';
...
// System audit row for an automated price change — mirrors @sparx/commerce's
