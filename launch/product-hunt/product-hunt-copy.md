...
## 2. Tagline · _PH limit: 60 characters_

**Primary (56 chars):**

```
The first business OS your AI agent can actually operate
```

**Backups (all ≤60), in case the primary reads too bold for the category:**

| Tagline                                             | Chars | Note                   |
| --------------------------------------------------- | ----- | ---------------------- |
| `Run your whole business by asking your AI.`        | 42    | Verb-first, demo-able  |
| `The content & commerce OS your AI can run.`        | 42    | Narrower, concrete     |
| `One modular OS for content, commerce & AI agents.` | 49    | Leads with modular     |
| `Your business, finally legible to your AI.`        | 42    | Emotional, MCP-forward |
...
| Field              | Value                         |
| ------------------ | ----------------------------- |
| Website (required) | `https://sparx.works`         |
| Pricing page       | `https://sparx.works/pricing` |
| Docs / developer   | `https://sparx.works/docs`    |
| X / Twitter        | _(your handle)_               |

---

## 4. Topics · _pick up to 3_

**Recommended set (matches the AI lead, maximizes reach on launch day):**

1. **Artificial Intelligence**
2. **SaaS**
3. **E-Commerce**

**Swap-in alternates** depending on which community you want to surface in:

- **No-Code** — strong fit for the visual builder / permanence story
- **CRM** — if you'd rather ride the CRM tag's traffic
- **Developer Tools** — leans into MCP / API-first / headless
- **Marketing** — email + CMS audience

> PH only allows 3. AI + SaaS are non-negotiable for this angle; the third slot is the lever.
> If launch-day discussion skews builder/permanence, switch slot 3 to **No-Code**.

---

## 5. Description · _PH limit: 260 characters_
...
```
A modular content & commerce OS your AI can actually run. Site builder, CMS, CRM, commerce, email, B2B & dropship — one dashboard, one bill, MCP-native. Turn on what you need. Live in 5 min.
```
...
bolted on the side. Your real business data, finally legible to the AI you already use.

Three things make it different:

• Modular. Turn on only what you need. A blogger runs Builder + CMS. A wholesale
  distributor runs Commerce + B2B + CRM. You never pay for a $2,400/mo plan to unlock
  the one feature you wanted.

• MCP-native. Every module is exposed to your AI agent out of the box. Ask questions,
...
I'd genuinely love your read on the MCP angle: if your AI could run one part of your
business for you tomorrow, which part would you hand over first? 👇
```

---

## 7. Gallery captions (the 8 frames)

> Frame order = the narrative. Frame 1 is also the feed thumbnail, so it has to land the
> hook standalone. Build specs + the branded template live in `gallery/` (see the kit README).
...
## 10. Social amplification (post when the launch goes live)
...
One platform. One bill. Live in 5 min.
...
Copilot can read your customers and orders and do the work, in plain language.

Turn on only the modules you need. Replace the Shopify + HubSpot + Mailchimp + Zapier
stack. Live in 5 minutes — and built to last, not just to launch.

If you've got 30 seconds, a look (and an upvote) means a lot: [PH link]
```
...
- [ ] Tagline ≤60 chars (primary is 56) ✓
- [ ] Description ≤260 chars (primary is 258) ✓
- [ ] 3 topics selected (AI · SaaS · E-Commerce)
- [ ] 8 gallery images exported at **1270×760** (or 2540×1520 @2x), frame 1 first
- [ ] Logo / thumbnail 240×240 with the indigo "x"
- [ ] First comment ready to paste the instant it goes live
- [ ] PH promo code created + echoed in the first comment
- [ ] Pricing numbers reconciled with the live pricing page
- [ ] Launch scheduled for **12:01 AM PT** (PH day boundary)
